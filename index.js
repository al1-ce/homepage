...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    _showHide(elements, show) {
      var t2, t3, t4, t5, t6, t7, space, oldDisplay, t8, display, e, hidden,
        _s10_ = "olddisplay",
        t1 = type$.Element,
    ...
    _EventUtil_add(eventTarget, types, handler, selector) {
      var space, t1, events, eventHandles, t2, t3, t4, t5, t6, t7, t8, _i, _box_0, type, namespaces, t9, t10, type0, eventHandle, handleObjCtx;
      ...
      for (; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
        ...
        if (J.indexOf$1$asx(type, ".") >= 0) {
          ...
          _box_0.type = type;
          if (!!namespaces.immutable$list)
            A.throwExpression(A.UnsupportedError$("sort"));
          t9 = namespaces.length - 1;
          if (t9 - 0 <= 32)
            A.Sort__insertionSort(namespaces, 0, t9, J._interceptors_JSArray__compareAny$closure(), t8);
          else
            A.Sort__dualPivotQuicksort(namespaces, 0, t9, J._interceptors_JSArray__compareAny$closure(), t8);
        }
        if (type.length === 0)
          continue;
        t9 = $.$get$_SPECIAL_HANDLINGS();
        t10 = t9.$index(0, type);
        if (t10 == null)
          t10 = $.$get$_SpecialEventHandler_EMPTY();
        _box_0.special = t10;
        type0 = t10.bindType;
        if (type0 == null)
          type0 = type;
        _box_0.type = type0;
        t9 = t9.$index(0, type0);
        _box_0.special = t9 == null ? $.$get$_SpecialEventHandler_EMPTY() : t9;
        t9 = B.JSArray_methods.join$1(namespaces, ".");
        ...
        B.JSArray_methods.add$1(handleObjCtx.handlers, new A._HandleObject(selector, type, t9, false, handler));
      }
    },
    _EventUtil_remove(elem, types, handler, selector, mappedTypes) {
      var t1, t2, t3, t4, t5, t6, _i, _box_0, type, t7, t8, namespaces, ns, _i0, type0, handleObjCtx, delegates, handlers, filter, space, eventHandles, eventHandle,
        _s11_ = "removeWhere",
      ...
      for (; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
        ...
        if (t8.indexOf$1(type, ".") >= 0) {
          ...
          if (!!namespaces.immutable$list)
            A.throwExpression(A.UnsupportedError$("sort"));
          t7 = A._arrayInstanceType(namespaces)._precomputed1;
          t8 = namespaces.length - 1;
          if (t8 - 0 <= 32)
            A.Sort__insertionSort(namespaces, 0, t8, J._interceptors_JSArray__compareAny$closure(), t7);
          else
            A.Sort__dualPivotQuicksort(namespaces, 0, t8, J._interceptors_JSArray__compareAny$closure(), t7);
          t7 = namespaces;
        }
        if (type.length === 0) {
        ...
        t7 = $.$get$_SPECIAL_HANDLINGS().$index(0, type);
        if (t7 == null)
          t7 = $.$get$_SpecialEventHandler_EMPTY();
        type0 = t7.bindType;
        if (type0 == null)
          type0 = type;
        ...
        if (delegates.length === 0 && handlers.length === 0) {
          ...
          if (t7 == null || !A.boolConversionCheck(t7.call$1(elem))) {
            t7 = $.$get$_dataPriv()._cache;
            t8 = false;
            if (t8)
              A.Expando__badExpandoKey(elem);
            space = t7._jsWeakMap.get(elem);
    ...
    _EventUtil_triggerEvent($event) {
      var t1, type, namespaces, eventPath, bubbleType, focusMorph, cur, t2, t3, t4, t5, first, _i, n, t6, t7, space, _null = null,
      ...
      t1 = $.$get$_SPECIAL_HANDLINGS().$index(0, type);
      if (t1 == null)
        t1 = $.$get$_SpecialEventHandler_EMPTY();
      if (!t1.noBubble && type$.Node._is(elem)) {
        bubbleType = t1.delegateType;
        if (bubbleType == null)
          bubbleType = type;
        ...
        bubbleType = _null;
      for (t2 = eventPath.length, t3 = type$.Map_dynamic_dynamic, t1 = t1.bindType, t4 = type$.dynamic, t5 = $event.originalEvent, first = true, _i = 0; _i < eventPath.length; eventPath.length === t2 || (0, A.throwConcurrentModificationError)(eventPath), ++_i, first = false) {
        n = eventPath[_i];
        ...
        if (!first)
          ...
          t6 = t1 == null ? type : t1;
        $event._type = t6;
        t6 = $.$get$_dataPriv()._cache;
        t7 = false;
        if (t7)
          A.Expando__badExpandoKey(n);
        space = t6._jsWeakMap.get(n);
        t6 = space == null ? _null : J.$index$asx(space, "events");
        t6 = t3._as(t6 == null ? A.LinkedHashMap_LinkedHashMap$_empty(t4, t4) : t6);
        t7 = $event._type;
        if (t7 == null) {
          t5.toString;
          t7 = J.get$type$x(t5);
      ...
      $event._type = type;
      t1 = $event.get$defaultPrevented($event);
      if (!t1)
        !(type === "click" && type$.Element._is(elem) && elem.tagName.toLowerCase() === "a".toLowerCase());
    },
    _EventUtil_dispatch(elem, dqevent, type) {
      var t1, handlerQueue, t2, t3, _i, matched, t4, t5, _i0, handleObj, t6, t7, eventns, hobjns, fn;
      if (type == null)
        type = dqevent.get$type(dqevent);
        ...
        for (t4 = A.List_List$of(matched.handlers, true, t2), t5 = t4.length, _i0 = 0; _i0 < t5; ++_i0) {
          ...
          if (t6 !== false) {
            ...
            if (A._EventUtil__subsetOf(eventns, hobjns)) {
              ...
              t6 = $.$get$_SPECIAL_HANDLINGS().$index(0, t6);
              fn = (t6 == null ? $.$get$_SpecialEventHandler_EMPTY() : t6).handle;
    ...
    _EventUtil_handlers(elem, dqevent, handleObjCtx) {
      ...
      if (delegates.length !== 0) {
        cur = _box_0.cur = dqevent.get$target(dqevent);
        t1 = type$.Node;
        if (t1._is(cur)) {
          t2 = type$.String;
          t3 = type$.bool;
    ...
    _cleanData(element) {
      ...
      for (t1 = J.get$children$x(element), t1 = t1.toList$0(t1), t2 = t1.length, t3 = type$.Object, t4 = type$.Map_dynamic_dynamic, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
        ...
        t7 = c == null;
        t8 = t7 ? t3._as(c) : c;
        if (A._isBool(t8) || typeof t8 == "number" || typeof t8 == "string" || false)
          A.Expando__badExpandoKey(t8);
        space = t6._jsWeakMap.get(t8);
        ...
        t5 = $.$get$_dataPriv()._cache;
        t6 = t7 ? t3._as(c) : c;
        t5._jsWeakMap.set(t6, null);
        A._cleanData(c);
      }
    },
    _domManip(refs, $content, f) {
      var t2, last, t3, t4,
        t1 = refs.get$length(refs);
      if (t1 === 0)
        return;
      t1 = A.$($content, null);
      t2 = t1.get$length(t1);
      ...
      for (t2 = A._instanceType(refs), t3 = new A.ListIterator(refs, refs.get$length(refs), t2._eval$1("ListIterator<ListBase.E>")), t2 = t2._eval$1("ListBase.E"); t3.moveNext$0();) {
    ...
    _prependFunc(ref, obj) {
      var before,
        t1 = ref.hasChildNodes();
      t1.toString;
      if (t1) {
        t1 = new A._ChildNodeListLazy(ref);
        before = t1.get$first(t1);
      } else
        before = null;
      obj.forEach$1(obj, new A._prependFunc_closure(ref, before));
    },
    _createMap($K, $V) {
    ...
    jsonDecode(source) {
      ...
      if (type$.List_nullable_Object._is(json))
    ...
    main() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, c, t1, t2, storage, re, isMobile, screenWidth, screenHeight, sel, selButtons, i, $async$temp1;
          ...
          switch ($async$goto) {
            case 0:
              ...
              if (!t2)
                ...
                A.throwExpression(A.Exception_Exception("Local storage is not available on this device"));
              if (t1) {
                storage = window.localStorage;
                if (storage.getItem("notes") == null)
                  storage.setItem("notes", "[]");
                if (storage.getItem("links") == null)
                  storage.setItem("links", A._asString($.$get$__linksPreset()));
    ...
    addLinkTo($name, href, whereid, priority, oid) {
      ...
      if (!t1) {
        ...
        A._domManip(q, A.Element_Element$html('            <button id="c-link-' + $.__link_id + '" class="c-link button-no-style">\n                ' + $name + "\n            </button>\n        ", _null, new A.NodeValidatorAllowAll()), A.dquery___appendFunc$closure());
  ...
  A._initMouseenterleave_closure.prototype = {
    call$1($event) {
      var target = type$.Node._as($event._currentTarget),
        related = type$.nullable_Node._as($event.get$relatedTarget($event)),
  ...
  (function installTearOffs() {
    ...
    _static(A, "dquery___createMap$closure", 0, null, ["call$2$0", "call$0"], ["_createMap", function() {
      return A._createMap(type$.dynamic, type$.dynamic);
    }], 81, 0);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure0Args, [A.nullFuture_closure, A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._Future__addListener_closure, A._Future__prependListeners_closure, A._Future__chainForeignFuture_closure1, A._Future__asyncCompleteWithValue_closure, A._Future__chainFuture_closure, A._Future__asyncCompleteError_closure, A._Future__propagateToListeners_handleWhenCompleteCallback, A._Future__propagateToListeners_handleValueCallback, A._Future__propagateToListeners_handleError, A.Stream_forEach_closure, A.Stream_forEach__closure, A.Stream_length_closure0, A.Stream_isEmpty_closure, A.Stream_first_closure, A._StreamController__subscribe_closure, A._StreamController__recordCancel_complete, A._BufferingStreamSubscription__sendDone_sendDone, A._PendingEvents_schedule_closure, A._cancelAndError_closure, A._cancelAndValue_closure, A._rootHandleError_closure, A._RootZone_bindCallbackGuarded_closure, A.Utf8Decoder__decoder_closure, A.Utf8Decoder__decoderNonfatal_closure, A.CanonicalizedMap_putIfAbsent_closure, A._EventUtil_add_closure, A._EventUtil_add_closure0, A._EventUtil_remove_closure_matchNamespaces, A._EventUtil_handlers_closure, A.MediaType_MediaType$parse_closure, A.Highlighter_closure, A.Highlighter__writeFileStart_closure, A.Highlighter__writeMultilineHighlights_closure, A.Highlighter__writeMultilineHighlights_closure0, A.Highlighter__writeMultilineHighlights_closure1, A.Highlighter__writeMultilineHighlights_closure2, A.Highlighter__writeMultilineHighlights__closure, A.Highlighter__writeMultilineHighlights__closure0, A.Highlighter__writeHighlightedText_closure, A.Highlighter__writeIndicator_closure, A.Highlighter__writeIndicator_closure0, A.Highlighter__writeIndicator_closure1, A.Highlighter__writeSidebar_closure, A._Highlight_closure]);
    _inheritMany(A.Iterable, [A.EfficientLengthIterable, A.MappedIterable, A.WhereIterable, A.ExpandIterable, A.TakeIterable, A.SkipIterable, A.WhereTypeIterable, A._ConstantMapKeyIterable, A._AllMatchesIterable, A._StringAllMatchesIterable]);
