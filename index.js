...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _showHide(elements, show) {
      var t2, t3, t4, t5, t6, space, oldDisplay, t7, t8, display, e, hidden,
        _s10_ = "olddisplay",
        t1 = type$.Element,
    ...
    _EventUtil_triggerEvent($event) {
      var t1, type, namespaces, eventPath, special, bubbleType, focusMorph, cur, t2, t3, t4, t5, first, _i, n, t6, t7, space, _null = null,
    ...
    _cleanData(element) {
      var t1, t2, t3, t4, _i, c, t5, t6, t7, space;
      for (t1 = J.get$children$x(element), t1 = t1.toList$0(t1), t2 = t1.length, t3 = type$.Object, t4 = type$.Map_dynamic_dynamic, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
        ...
        t6 = c == null;
        t7 = t6 ? t3._as(c) : c;
        if (A._isBool(t7) || typeof t7 == "number" || typeof t7 == "string" || false)
    ...
    main() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, c, t1, storage, re, isMobile, screenWidth, screenHeight, sel, selButtons, i, t2, $async$temp1;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = !$.__usingLocalStorage ? 3 : 4;
              break;
            case 3:
              // then
              t1 = type$.void_Function_QueryEvent;
              A.$("#bk-login", null)._on$4("click", t1._as(new A.main_closure2()), null, false);
              A.$("#bk-logout", null)._on$4("click", t1._as(new A.main_closure3()), null, false);
              $async$temp1 = A;
              $async$goto = 5;
            ...
            case 4:
              ...
              t1 = type$.void_Function_QueryEvent;
              A.$("#newtask", null)._on$4("click", t1._as(new A.main_closure4()), null, false);
              A.$("#newnote", null)._on$4("click", t1._as(new A.main_closure5()), null, false);
              A.$("#newnote-cancel", null)._on$4("click", t1._as(new A.main_closure6()), null, false);
              A.$("#newnote-delete", null)._on$4("click", t1._as(new A.main_closure7()), null, false);
              A.$("#newnote-create", null)._on$4("click", t1._as(new A.main_closure8()), null, false);
              A.$("#links-close", null)._on$4("click", t1._as(new A.main_closure9()), null, false);
              A.$("#edit-links", null)._on$4("click", t1._as(new A.main_closure10()), null, false);
            case 1:
              // return
              return A._asyncReturn($async$returnValue, $async$completer);
          }
    ...
    setPageTo(page) {
      ...
      A._showHide(A.$("#c-page-tool", _null)._elements, false);
    ...
    addLinkTo($name, href, whereid, priority, oid) {
      var q, t2, _null = null,
        ...
        escWhereid = A.stringReplaceAllUnchecked(whereid, " ", "-"),
        t1 = oid === "",
    ...
    call$1(handleObj) {
      ...
      if (_this.mappedTypes || _this.origType === handleObj.origType) {
        ...
        if (t2 == null || J.$eq$(t2, handleObj.handler)) {
          if (t1.namespaces.length === 0 || A.boolConversionCheck(new A._EventUtil_remove_closure_matchNamespaces(t1, handleObj).call$0()))
            t1 = true;
          else
            t1 = false;
          res = t1;
  ...
  A.main_closure2.prototype = {
    call$1(e) {
      return this.$call$body$main_closure5(type$.QueryEvent._as(e));
    },
  ...
  A.main_closure3.prototype = {
    call$1(e) {
      return this.$call$body$main_closure4(type$.QueryEvent._as(e));
    },
    $call$body$main_closure4(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, t1;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
  ...
  A.main_closure4.prototype = {
    call$1(e) {
      return this.$call$body$main_closure3(type$.QueryEvent._as(e));
    },
    $call$body$main_closure3(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
  ...
  A.main_closure5.prototype = {
    call$1(e) {
      return this.$call$body$main_closure2(type$.QueryEvent._as(e));
    },
    $call$body$main_closure2(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        t1;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
  ...
  A.main_closure6.prototype = {
    call$1(e) {
      return this.$call$body$main_closure1(type$.QueryEvent._as(e));
    },
    $call$body$main_closure1(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void);
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
  ...
  A.main_closure7.prototype = {
    call$1(e) {
      return this.$call$body$main_closure0(type$.QueryEvent._as(e));
    },
    $call$body$main_closure0(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, t1;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
  ...
  A.main_closure8.prototype = {
    call$1(e) {
      return this.$call$body$main_closure(type$.QueryEvent._as(e));
    },
  ...
  (function installTearOffs() {
    ...
    _instance_2_u(A._Future.prototype, "get$_completeError", "_completeError$2", 30);
    ...
    _static_2(A, "collection_ListBase__compareAny$closure", "ListBase__compareAny", 14);
    ...
    _instance_2_i(A.HttpRequest.prototype, "get$setRequestHeader", "setRequestHeader$2", 6);
    _static_1(A, "js___convertToJS$closure", "_convertToJS", 78);
    _static_1(A, "js___convertToDart$closure", "_convertToDart", 79);
    _static_2(A, "dquery___appendFunc$closure", "_appendFunc", 25);
    _static_2(A, "dquery___prependFunc$closure", "_prependFunc", 25);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "Future<~>(QueryEvent)", "Null()", "@(@)", "Null(@)", "~(QueryEvent)", "~(String,String)", "~(Element)", "~(String,@)", "~(@)", "String(String)", "Future<Response>(Client)", "bool(String)", "~(~())", "int(@,@)", "Null(Event)", "bool(_Highlight)", "~(Event)", "bool(EventTarget,@)", "bool()", "bool(NodeValidator)", "bool(Element,String,String,_Html5NodeValidator)", "bool(Node)", "Null(ProgressEvent)", "String(Match)", "~(Element,ElementQuery)", "int()", "@()", "bool(EventTarget?)", "~(Object?,Object?)", "~(Object,StackTrace)", "bool(Object?,Object?)", "int(Object?)", "~(Uint8List,String,int)", "Uint8List(@,@)", "~(Node,Node?)", "@(@,@)", "bool(Set<String>)", "Element(Node)", "bool(@)", "JsFunction(@)", "JsArray<@>(@)", "JsObject(@)", "~(EventTarget)", "Element(Element)", "Null(@)()", "_HandleObjectContext()", "bool(_HandleObject)", "~(@,@)", "@(@,String)", "Null(~())", "~(Object?)", "EventTarget(@)", "~(Symbol0,@)", "0^(0^,0^)<num>", "int(String)", "~(String,int)", "~(List<int>)", "MediaType()", "~(String,int?)", "String(String?)", "String?()", "int(_Line)", "int(int,int)", "Object(_Line)", "Object(_Highlight)", "int(_Highlight,_Highlight)", "List<_Line>(MapEntry<Object,List<_Highlight>>)", "Null(@,StackTrace)", "SourceSpanWithContext()", "~(String,Object)", "~(String,String?)", "Future<Null>()", "~(int,@)", "~(Object[StackTrace?])", "@(String)", "Null(Object,StackTrace)", "_Future<@>(@)", "Object?(Object?)", "Object?(@)", "Null(~)", "Map<0^,1^>()<Object?,Object?>", "bool(String,String)"],
