...
(function dartProgram() {
  ...
  var J = {
    ...
    get$defaultPrevented$x(receiver) {
    ...
    _querySelectorAll$1$x(receiver, a0) {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _Uri__makeHttpUri(scheme, authority, unencodedPath, queryParameters) {
      var hostStart, i, hostEnd, escapeForZoneID, char, hostEnd0, t2, portString, host, _null = null,
        t1 = authority.length,
        userInfo = "",
        port = _null;
      if (t1 !== 0) {
        ...
        if (hostStart < t1 && authority.charCodeAt(hostStart) === 91) {
          for (hostEnd = hostStart, escapeForZoneID = -1; hostEnd < t1; ++hostEnd) {
            char = authority.charCodeAt(hostEnd);
          ...
          if (hostEnd !== t1) {
            if (!(hostEnd < t1))
              return A.ioore(authority, hostEnd);
            t2 = authority.charCodeAt(hostEnd) !== 58;
          } else
            t2 = false;
          if (t2)
          ...
          hostEnd = hostStart;
        for (; hostEnd < t1; ++hostEnd)
          if (authority.charCodeAt(hostEnd) === 58) {
    ...
    $(selector, context) {
      ...
      if (typeof selector == "string")
        selector = B.JSString_methods.trim$0(selector);
      if (selector == null || selector === "")
        return new A._ElementQuery(A._setArrayType([], type$.JSArray_Element));
      if (typeof selector == "string") {
        if (B.JSString_methods.startsWith$1(selector, "<"))
          return new A._ElementQuery(A._setArrayType([A.Element_Element$html(selector, _null, _null)], type$.JSArray_Element));
        if (context == null)
          return $.$get$_rootDQuery().find$1(0, selector);
        else if (type$.HtmlDocument._is(context))
          return new A._DocumentQuery(context).find$1(0, selector);
        else if (type$.Element._is(context))
          return new A._ElementQuery(A._setArrayType([context], type$.JSArray_Element)).find$1(0, selector);
        throw A.wrapException(A.ArgumentError$("Context type should be Document, Element, or DQuery: " + A.S(context), _null));
      }
      if (type$.Element._is(selector))
        return new A._ElementQuery(A._setArrayType([selector], type$.JSArray_Element));
      if (type$.List_Element._is(selector))
        return new A._ElementQuery(selector);
      throw A.wrapException(A.ArgumentError$("Selector type should be String, Element, or List<Element>: " + A.S(selector), _null));
    },
    _isHidden(elem) {
      var t2,
        t1 = elem.style.display;
      t1.toString;
      t2 = true;
      if (t1 !== "none") {
        t1 = J.getComputedStyle$0$x(elem).display;
        t1.toString;
        if (t1 !== "none") {
          t1 = elem.ownerDocument;
          t1 = (t1 == null ? null : J.contains$1$asx(t1, elem)) !== true;
        } else
          t1 = t2;
      } else
        t1 = t2;
    ...
    _showHide(elements, show) {
      var t2, t3, t4, t5, space, oldDisplay, t6, t7, t8, display, e, hidden,
        _s10_ = "olddisplay",
        t1 = type$.Element,
        values = A.LinkedHashMap_LinkedHashMap$_empty(t1, type$.String);
      for (t2 = J.getInterceptor$ax(elements), t3 = t2.get$iterator(elements); t3.moveNext$0();) {
        t4 = t3.get$current(t3);
        t5 = $.$get$_dataPriv();
        space = t5._cache._jsWeakMap.get(t4);
        oldDisplay = space == null ? null : J.$index$asx(space, _s10_);
        t6 = oldDisplay == null;
        if (!t6)
          values.$indexSet(0, t4, A._asString(oldDisplay));
        t7 = t4.style;
        t8 = t7.display;
        t8.toString;
        if (show) {
          ...
          t6 = t4.style.display;
          t6.toString;
          if (t6 === "" && A._isHidden(t4)) {
            t6 = t4.tagName;
            t6.toString;
            display = $._elemDisplay.$index(0, t6);
            if (display == null) {
              t7 = document;
              t7.toString;
              e = t1._as(A._ElementFactoryProvider_createElement_tag(t6, null));
              t7 = t7.body;
              if (t7 != null)
                t7.appendChild(e).toString;
              t7 = window;
              t7.toString;
              t7 = B.Window_methods._getComputedStyle$2(t7, e, "").display;
              t7.toString;
              t8 = e.parentNode;
              if (t8 != null)
                t8.removeChild(e).toString;
              $._elemDisplay.$indexSet(0, t6, t7);
              display = t7;
            }
            values.$indexSet(0, t4, display);
            J.$indexSet$ax(t5.getSpace$1(t4), _s10_, display);
          }
        } else if (!values.containsKey$1(0, t4)) {
          hidden = A._isHidden(t4);
          if (t8.length !== 0 && t8 !== "none" || !hidden) {
            if (hidden)
              t6 = t8;
            else {
              t6 = t4.style.display;
            ...
            J.$indexSet$ax(t5.getSpace$1(t4), _s10_, t6);
          }
        }
      }
      for (t1 = t2.get$iterator(elements); t1.moveNext$0();) {
    ...
    _Storage$($name) {
      return new A._Storage(new A.Expando(new WeakMap(), $name, type$.Expando_Map_String_dynamic));
    },
    _DocumentQuery$(doc) {
      var t1;
      if (doc == null) {
        ...
        t1 = doc;
      return new A._DocumentQuery(t1);
    },
    _EventUtil_add(eventTarget, types, handler, selector) {
      var space, t1, events, eventHandles, t2, t3, t4, t5, t6, t7, _i, _box_0, type, namespaces, t8, special, type0, eventHandle, handleObjCtx;
      if (type$.CharacterData._is(eventTarget))
        return;
      space = $.$get$_dataPriv().getSpace$1(eventTarget);
      t1 = J.getInterceptor$x(space);
      events = t1.putIfAbsent$2(space, "events", B.CONSTANT);
      eventHandles = t1.putIfAbsent$2(space, "handles", B.CONSTANT);
      t1 = B.JSString_methods.split$1(types, $.$get$_EventUtil__SPACES());
      t2 = t1.length;
      t3 = J.getInterceptor$x(eventHandles);
      t4 = type$.dynamic_Function_Event;
      t5 = J.getInterceptor$x(events);
      t6 = type$._HandleObjectContext;
      t7 = type$.JSArray_String;
      _i = 0;
      for (; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
        _box_0 = {};
        type = _box_0.type = t1[_i];
        namespaces = A._setArrayType([], t7);
        if (J.indexOf$1$asx(type, ".") >= 0) {
          namespaces = A._setArrayType(type.split("."), t7);
          type = B.JSArray_methods.removeAt$1(namespaces, 0);
          _box_0.type = type;
          B.JSArray_methods.sort$0(namespaces);
        }
        if (type.length === 0)
          continue;
        t8 = $.$get$_SPECIAL_HANDLINGS();
        special = t8.$index(0, type);
        if (special == null)
          special = $.$get$_SpecialEventHandler_EMPTY();
        _box_0.special = special;
        type0 = special.bindType;
        if (type0 == null)
          type0 = type;
        _box_0.type = type0;
        special = t8.$index(0, type0);
        _box_0.special = special == null ? $.$get$_SpecialEventHandler_EMPTY() : special;
        t8 = B.JSArray_methods.join$1(namespaces, ".");
        eventHandle = t4._as(t3.putIfAbsent$2(eventHandles, type0, new A._EventUtil_add_closure(_box_0, eventTarget)));
        handleObjCtx = t6._as(t5.putIfAbsent$2(events, _box_0.type, new A._EventUtil_add_closure0(_box_0, eventTarget, eventHandle)));
        B.JSArray_methods.add$1(handleObjCtx.handlers, new A._HandleObject(selector, type, t8, false, handler));
      }
    },
    _EventUtil_remove(elem, types, handler, selector, mappedTypes) {
      var t1, t2, t3, t4, t5, t6, _i, _box_0, type, t7, t8, namespaces, ns, _i0, special, type0, handleObjCtx, delegates, handlers, filter, space, eventHandles, eventHandle,
        _s11_ = "removeWhere",
        events = $.$get$_dataPriv().$get$2(0, elem, "events");
      if (events == null)
        return;
      t1 = B.JSString_methods.split$1(types, $.$get$_EventUtil__SPACES());
      t2 = t1.length;
      ...
      t5 = type$.nullable_dynamic_Function_Event;
      t6 = J.getInterceptor$x(elem);
      _i = 0;
      for (; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
        _box_0 = {};
        type = t1[_i];
        t7 = _box_0.namespaces = A._setArrayType([], t4);
        t8 = J.getInterceptor$asx(type);
        if (t8.indexOf$1(type, ".") >= 0) {
          namespaces = _box_0.namespaces = t8.split$1(type, ".");
          type = B.JSArray_methods.removeAt$1(namespaces, 0);
          B.JSArray_methods.sort$0(namespaces);
          t7 = namespaces;
        }
        if (type.length === 0) {
          ns = B.JSArray_methods.join$1(t7, ".");
          for (t7 = J.toList$0$ax(t3.get$keys(events)), t8 = t7.length, _i0 = 0; _i0 < t7.length; t7.length === t8 || (0, A.throwConcurrentModificationError)(t7), ++_i0)
            A._EventUtil_remove(elem, A.S(t7[_i0]) + "." + ns, handler, selector, true);
          continue;
        }
        ...
        filter = new A._EventUtil_remove_closure(_box_0, mappedTypes, type, handler, selector);
        A._arrayInstanceType(delegates)._eval$1("bool(1)")._as(filter);
        if (!!delegates.fixed$length)
          A.throwExpression(A.UnsupportedError$(_s11_));
        B.JSArray_methods._removeWhere$2(delegates, filter, true);
        A._arrayInstanceType(handlers)._eval$1("bool(1)")._as(filter);
        if (!!handlers.fixed$length)
          A.throwExpression(A.UnsupportedError$(_s11_));
        B.JSArray_methods._removeWhere$2(handlers, filter, true);
        if (delegates.length === 0 && handlers.length === 0) {
          t7 = special.teardown;
          if (t7 == null || !A.boolConversionCheck(t7.call$1(elem))) {
            t7 = $.$get$_dataPriv();
            space = t7._cache._jsWeakMap.get(elem);
            eventHandles = space == null ? null : J.$index$asx(space, "handles");
            if (eventHandles != null) {
              eventHandle = J.$index$asx(eventHandles, type0);
              if (eventHandle != null)
                t6.removeEventListener$2(elem, type0, t5._as(eventHandle));
            }
          }
          t3.remove$1(events, type0);
        }
      }
      if (A._asBool(t3.get$isEmpty(events))) {
        t1 = $.$get$_dataPriv();
        type$.Node._as(elem);
        t1.remove$2(0, elem, "handles");
        t1.remove$2(0, elem, "events");
      }
    },
    _EventUtil__subsetOf(a, b) {
      var t2, _i, sb, t3, c,
        t1 = A._arrayInstanceType(a),
        ia = new J.ArrayIterator(a, a.length, t1._eval$1("ArrayIterator<1>"));
      for (t2 = b.length, t1 = t1._precomputed1, _i = 0; _i < b.length; b.length === t2 || (0, A.throwConcurrentModificationError)(b), ++_i) {
        sb = b[_i];
        if (!ia.moveNext$0())
          return true;
        t3 = ia._current;
    ...
    _EventUtil_triggerEvent($event) {
      var t1, type, namespaces, eventPath, special, bubbleType, focusMorph, cur, t2, t3, t4, t5, first, _i, n, t6, space, t7, _null = null,
        elem = $event.get$target(0);
      if (elem == null) {
        t1 = document;
        t1.toString;
        elem = t1;
      ...
      namespaces = A._setArrayType([], t1);
      if (B.JSString_methods.indexOf$1(type, ".") >= 0) {
        namespaces = A._setArrayType(type.split("."), t1);
        type = B.JSArray_methods.removeAt$1(namespaces, 0);
        B.JSArray_methods.sort$0(namespaces);
      }
      B.JSString_methods.indexOf$1(type, ":");
      eventPath = A._setArrayType([elem], type$.JSArray_EventTarget);
      if (type$.CharacterData._is(elem))
        return;
      t1 = $._EventUtil__triggered;
      if (!(type === "focusin" && t1 === "focus"))
        t1 = type === "focusout" && t1 === "blur";
      else
        t1 = true;
      if (t1)
        return;
      if (namespaces.length !== 0)
        $event._namespace = B.JSArray_methods.join$1(namespaces, ".");
      $event._reNamespace = $event._namespace != null ? A.RegExp_RegExp("(^|\\.)" + B.JSArray_methods.join$1(namespaces, "\\.(?:.*\\.|)") + "(\\.|$)") : _null;
      special = $.$get$_SPECIAL_HANDLINGS().$index(0, type);
      if (special == null)
        special = $.$get$_SpecialEventHandler_EMPTY();
      if (!special.noBubble && type$.Node._is(elem)) {
        bubbleType = special.delegateType;
        if (bubbleType == null)
          bubbleType = type;
        if (!(bubbleType === "focusin" && type === "focus"))
          focusMorph = bubbleType === "focusout" && type === "blur";
        else
          focusMorph = true;
        cur = focusMorph ? elem : elem.parentNode;
        for (; cur != null; cur = cur.parentNode)
          B.JSArray_methods.add$1(eventPath, cur);
      } else
        bubbleType = _null;
      for (t1 = eventPath.length, t2 = type$.Map_dynamic_dynamic, t3 = special.bindType, t4 = type$.dynamic, t5 = $event.originalEvent, first = true, _i = 0; _i < eventPath.length; eventPath.length === t1 || (0, A.throwConcurrentModificationError)(eventPath), ++_i, first = false) {
        n = eventPath[_i];
        ...
        $event._type = t6;
        t6 = $.$get$_dataPriv();
        space = t6._cache._jsWeakMap.get(n);
        t6 = space == null ? _null : J.$index$asx(space, "events");
        t6 = t2._as(t6 == null ? A.LinkedHashMap_LinkedHashMap$_empty(t4, t4) : t6);
        t7 = $event._type;
        if (t7 == null) {
          t5.toString;
          t7 = J.get$type$x(t5);
        }
        if (J.containsKey$1$x(t6, t7))
          A._EventUtil_dispatch(n, $event, _null);
      }
      $event._type = type;
      t1 = $event.get$defaultPrevented(0);
      if (!t1)
        if (type === "click")
          if (type$.Element._is(elem))
            elem.tagName.toString;
    },
    _EventUtil_dispatch(elem, dqevent, type) {
      var t1, handlerQueue, t2, t3, _i, matched, t4, t5, _i0, handleObj, t6, t7, eventns, hobjns, special, fn;
      if (type == null)
        type = dqevent.get$type(0);
      t1 = J.$index$asx(A._EventUtil__getEvents(elem), type);
      if (t1 == null)
        t1 = $.$get$_HandleObjectContext_EMPTY();
      type$._HandleObjectContext._as(t1);
      dqevent._delegateTarget = elem;
      handlerQueue = A._EventUtil_handlers(elem, dqevent, t1);
      for (t1 = handlerQueue.length, t2 = type$._HandleObject, t3 = type$.JSArray_String, _i = 0; _i < handlerQueue.length; handlerQueue.length === t1 || (0, A.throwConcurrentModificationError)(handlerQueue), ++_i) {
        matched = handlerQueue[_i];
        if (dqevent._propagationStopped)
          break;
        dqevent._currentTarget = matched.elem;
        for (t4 = A.List_List$of(matched.handlers, true, t2), t5 = t4.length, _i0 = 0; _i0 < t5; ++_i0) {
          handleObj = t4[_i0];
          t6 = dqevent._reNamespace;
          if (t6 == null)
            t6 = null;
          else {
            t7 = handleObj.namespace;
            t6 = t6._nativeRegExp;
            t6 = t6.test(t7);
          }
          if (t6 !== false) {
            t6 = dqevent._namespace;
            eventns = t6 == null ? null : A._setArrayType(t6.split("."), t3);
            if (eventns == null)
              eventns = A._setArrayType([], t3);
            hobjns = A._setArrayType(handleObj.namespace.split("."), t3);
            if (A._EventUtil__subsetOf(eventns, hobjns)) {
              dqevent.set$_handleObj(handleObj);
              t6 = handleObj.origType;
              special = $.$get$_SPECIAL_HANDLINGS().$index(0, t6);
              fn = (special == null ? $.$get$_SpecialEventHandler_EMPTY() : special).handle;
              (fn == null ? handleObj.handler : fn).call$1(dqevent);
            }
          }
        }
      }
    },
    _EventUtil_handlers(elem, dqevent, handleObjCtx) {
      var cur, t1, t2, t3, t4, t5, matches, matched, _i, handleObj, _box_0 = {},
        handlerQueue = A._setArrayType([], type$.JSArray__HandlerQueueEntry),
        delegates = handleObjCtx.delegates,
        handlers = handleObjCtx.handlers;
      if (delegates.length !== 0) {
        cur = _box_0.cur = dqevent.get$target(0);
        t1 = type$.Node;
        if (t1._is(cur)) {
          t2 = type$.String;
          t3 = type$.bool;
          t4 = type$.JSArray__HandleObject;
          t5 = cur;
          while (t5 == null ? elem != null : t5 !== elem) {
            matches = A.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
            matched = A._setArrayType([], t4);
            for (t5 = delegates.length, _i = 0; _i < delegates.length; delegates.length === t5 || (0, A.throwConcurrentModificationError)(delegates), ++_i) {
              handleObj = delegates[_i];
              if (A.boolConversionCheck(matches.putIfAbsent$2(0, " ", new A._EventUtil_handlers_closure(_box_0, handleObj, " ", elem))))
                B.JSArray_methods.add$1(matched, handleObj);
            }
            if (matched.length !== 0)
              B.JSArray_methods.add$1(handlerQueue, new A._HandlerQueueEntry(t1._as(_box_0.cur), matched));
            t5 = _box_0.cur;
            cur = t1._is(t5) ? t5.parentNode : null;
            if (cur == null)
              cur = elem;
            _box_0.cur = cur;
            t5 = cur;
      ...
      if (handlers.length !== 0)
        B.JSArray_methods.add$1(handlerQueue, new A._HandlerQueueEntry(elem, handlers));
      return handlerQueue;
    },
    _EventUtil__getEvents(elem) {
      var t1 = $.$get$_dataPriv().$get$2(0, elem, "events");
      if (t1 == null) {
        t1 = type$.dynamic;
    ...
    _HandleObjectContext$() {
      var t1 = type$.JSArray__HandleObject;
      return new A._HandleObjectContext(A._setArrayType([], t1), A._setArrayType([], t1));
    },
    _SpecialEventHandler$(bindType, delegateType, handle, noBubble, setup, teardown, trigger) {
      return new A._SpecialEventHandler(noBubble, setup, teardown, delegateType, bindType, handle);
    },
    _initMouseenterleave(orig, fix) {
      return new A._SpecialEventHandler(false, null, null, fix, fix, new A._initMouseenterleave_closure(fix));
    },
    _initNotSupportFocusinBubbles(orig, fix) {
      var handler, t1 = {};
      t1.attaches = 0;
      handler = new A._initNotSupportFocusinBubbles_closure(fix);
      return new A._SpecialEventHandler(false, new A._initNotSupportFocusinBubbles_closure0(t1, orig, handler), new A._initNotSupportFocusinBubbles_closure1(t1, orig, handler), null, null, null);
    },
    _cleanData(element) {
      var t1, t2, t3, t4, _i, c, t5, t6, t7, t8, space, _i0;
      for (t1 = J.get$children$x(element), t1 = t1.toList$0(t1), t2 = t1.length, t3 = type$.Object, t4 = type$.Map_dynamic_dynamic, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
        c = t1[_i];
        t5 = $.$get$_dataPriv();
        t6 = c == null;
        t7 = t6 ? t3._as(c) : c;
        ...
        if (!A._isBool(t7))
          if (typeof t7 != "number")
            t8 = typeof t7 == "string";
        if (t8)
          A.Expando__badExpandoKey(t7);
        space = t5._cache._jsWeakMap.get(t7);
        if (!(space != null && !J.get$isEmpty$asx(space)))
          continue;
        space = t5.getSpace$1(c);
        t5 = J.getInterceptor$x(space);
        if (t5.containsKey$1(space, "events"))
          for (t5 = J.toList$0$ax(J.get$keys$x(t4._as(t5.$index(space, "events")))), t7 = t5.length, _i0 = 0; _i0 < t5.length; t5.length === t7 || (0, A.throwConcurrentModificationError)(t5), ++_i0)
            A._EventUtil_remove(c, A._asString(t5[_i0]), null, null, false);
        t5 = $.$get$_dataPriv();
        t6 = t6 ? t3._as(c) : c;
        t5._cache._jsWeakMap.set(t6, null);
        A._cleanData(c);
      }
    },
    _domManip(refs, $content, f) {
      var t2, last, t3, t4,
        t1 = refs.get$length(0);
      if (t1 === 0)
        return;
      t1 = A.$($content, null);
      t2 = t1.get$length(0);
      ...
      for (t2 = A._instanceType(refs), t3 = new A.ListIterator(refs, refs.get$length(0), t2._eval$1("ListIterator<ListBase.E>")), t2 = t2._eval$1("ListBase.E"); t3.moveNext$0();) {
        t4 = t3.__internal$_current;
        if (t4 == null)
          t4 = t2._as(t4);
        f.call$2(t4, t4 === last ? t1 : t1.clone$0(0));
      }
    },
    _appendFunc(ref, obj) {
      return obj.forEach$1(obj, new A._appendFunc_closure(ref));
    },
    _prependFunc(ref, obj) {
      var t1 = ref.hasChildNodes();
      t1.toString;
      obj.forEach$1(obj, new A._prependFunc_closure(ref, t1 ? new A._ChildNodeListLazy(ref).get$first(0) : null));
    },
    _createMap($K, $V) {
      return A.LinkedHashMap_LinkedHashMap$_empty($K, $V);
    },
    _Storage: function _Storage(t0) {
      this._cache = t0;
    },
    _Query: function _Query() {
    },
    _Query__on_closure: function _Query__on_closure(t0, t1, t2) {
      this.types = t0;
      this.h = t1;
      this.selector = t2;
    },
    _DocumentQuery: function _DocumentQuery(t0) {
      this._doc = t0;
      this._dquery$_context = null;
    },
    _ElementQuery: function _ElementQuery(t0) {
      this._elements = t0;
      this._dquery$_context = this._selector = null;
    },
    _ElementQuery_clone_closure: function _ElementQuery_clone_closure() {
    },
    _ElementQuery_detach_closure: function _ElementQuery_detach_closure(t0) {
      this.data = t0;
    },
    _ElementQuery_text_closure: function _ElementQuery_text_closure(t0) {
      this.value = t0;
    },
    _EventUtil_add_closure: function _EventUtil_add_closure(t0, t1) {
      this._box_0 = t0;
      this.eventTarget = t1;
    },
    _EventUtil_add__closure: function _EventUtil_add__closure(t0, t1) {
      this._box_0 = t0;
      this.eventTarget = t1;
    },
    _EventUtil_add_closure0: function _EventUtil_add_closure0(t0, t1, t2) {
      this._box_0 = t0;
      this.eventTarget = t1;
      this.eventHandle = t2;
    },
    _EventUtil_remove_closure: function _EventUtil_remove_closure(t0, t1, t2, t3, t4) {
      var _ = this;
      _._box_0 = t0;
      _.mappedTypes = t1;
      _.origType = t2;
    ...
    _EventUtil_remove_closure_matchNamespaces: function _EventUtil_remove_closure_matchNamespaces(t0, t1) {
      this._box_0 = t0;
      this.handleObj = t1;
    },
    _EventUtil_handlers_closure: function _EventUtil_handlers_closure(t0, t1, t2, t3) {
      var _ = this;
      _._box_0 = t0;
      _.handleObj = t1;
      _.sel = t2;
    ...
    _HandleObjectContext: function _HandleObjectContext(t0, t1) {
      this.delegates = t0;
      this.handlers = t1;
    },
    _HandlerQueueEntry: function _HandlerQueueEntry(t0, t1) {
      this.elem = t0;
      this.handlers = t1;
    },
    _HandleObject: function _HandleObject(t0, t1, t2, t3, t4) {
      var _ = this;
      _.selector = t0;
      _.origType = t1;
      _.namespace = t2;
    ...
    _SpecialEventHandler: function _SpecialEventHandler(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _.noBubble = t0;
      _.setup = t1;
      _.teardown = t2;
    ...
    _SPECIAL_HANDLINGS_closure: function _SPECIAL_HANDLINGS_closure() {
    },
    _SPECIAL_HANDLINGS_closure0: function _SPECIAL_HANDLINGS_closure0() {
    },
    _SPECIAL_HANDLINGS_closure1: function _SPECIAL_HANDLINGS_closure1() {
    },
    _initMouseenterleave_closure: function _initMouseenterleave_closure(t0) {
      this.fix = t0;
    },
    _initNotSupportFocusinBubbles_closure: function _initNotSupportFocusinBubbles_closure(t0) {
      this.fix = t0;
    },
    _initNotSupportFocusinBubbles_closure0: function _initNotSupportFocusinBubbles_closure0(t0, t1, t2) {
      this._box_0 = t0;
      this.orig = t1;
      this.handler = t2;
    },
    _initNotSupportFocusinBubbles_closure1: function _initNotSupportFocusinBubbles_closure1(t0, t1, t2) {
      this._box_0 = t0;
      this.orig = t1;
      this.handler = t2;
    },
    QueryEvent: function QueryEvent(t0, t1) {
      var _ = this;
      _.originalEvent = t0;
      _._type = t1;
      _._defaultPrevented = _._handleObj = _._reNamespace = _._namespace = _._target = _._currentTarget = _._delegateTarget = null;
      _._propagationStopped = false;
    },
    QueryEvent_relatedTarget_closure: function QueryEvent_relatedTarget_closure() {
    },
    QueryEvent_button_closure: function QueryEvent_button_closure() {
    },
    QueryEvent_defaultPrevented_closure: function QueryEvent_defaultPrevented_closure() {
    },
    _appendFunc_closure: function _appendFunc_closure(t0) {
      this.ref = t0;
    },
    _prependFunc_closure: function _prependFunc_closure(t0, t1) {
      this.ref = t0;
      this.before = t1;
    },
    __DocumentQuery__Query_ListMixin: function __DocumentQuery__Query_ListMixin() {
    },
    __ElementQuery__Query_ListMixin: function __ElementQuery__Query_ListMixin() {
    },
    get0(url, headers) {
      return A._withClient(new A.get_closure0(url, headers), type$.Response);
    },
    ...
    get_closure0: function get_closure0(t0, t1) {
      this.url = t0;
      this.headers = t1;
    },
    ...
    jsonDecode(source) {
      var json = B.C_JsonCodec.decode$2$reviver(0, source, null);
      if (Array.isArray(json))
        return A.LinkedHashMap_LinkedHashMap$_literal(["jsarr", json], type$.String, type$.dynamic);
      else
        return type$.Map_String_dynamic._as(json);
    },
    BackendlessDB_serverQURI(httpPath, queryParameters) {
      var t1 = $.BackendlessDB_serverURL;
      if (t1 === "")
        throw A.wrapException(A.Exception_Exception("App must be initialised"));
      return A._Uri__makeHttpUri("https", t1, httpPath, queryParameters);
    },
    UserService_login(userEmail, userPass, stayLoggedFor) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Map_String_dynamic),
        $async$returnValue, t2, t3, j, t1, $async$temp1, $async$temp2;
      var $async$UserService_login = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $.BackendlessDB_serverURL;
              if (t1 === "")
                A.throwExpression(A.Exception_Exception("App must be initialised"));
              t1 = A._Uri__makeHttpUri("https", t1, "api/users/login", null);
              t2 = type$.String;
              t3 = A.LinkedHashMap_LinkedHashMap$_literal(["Content-Type", "application/json"], t2, t2);
              $async$temp1 = A;
              $async$temp2 = B.C_Utf8Codec;
              $async$goto = 3;
              return A._asyncAwait(A.post(t1, B.C_JsonCodec.encode$2$toEncodable(A.LinkedHashMap_LinkedHashMap$_literal(["login", userEmail, "password", userPass], t2, t2), null), t3), $async$UserService_login);
            case 3:
              // returning from await.
              j = $async$temp1.jsonDecode($async$temp2.decode$1(0, $async$result.bodyBytes));
              t1 = J.getInterceptor$x(j);
              if (t1.containsKey$1(j, "user-token")) {
                t1 = A._asString(t1.$index(j, "user-token"));
                $.BackendlessDB_userToken = t1;
                if (stayLoggedFor > 0)
                  A.setCookie("userToken", t1, stayLoggedFor);
              }
              $async$returnValue = j;
              // goto return
              $async$goto = 1;
      ...
      return A._asyncStartSync($async$UserService_login, $async$completer);
    },
    UserService_logout() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, t1, t2;
      var $async$UserService_logout = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2 = type$.String;
              $async$goto = 3;
              return A._asyncAwait(A.get0(A._Uri__makeHttpUri("https", t1, "api/users/logout", null), A.LinkedHashMap_LinkedHashMap$_literal(["user-token", $.BackendlessDB_userToken], t2, t2)), $async$UserService_logout);
            case 3:
              // returning from await.
              // goto return
              $async$goto = 1;
      ...
      return A._asyncStartSync($async$UserService_logout, $async$completer);
    },
    UserService_isValidLogin() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.bool),
        $async$returnValue, t2, isLoggedIn, t1, $async$temp1;
      var $async$UserService_isValidLogin = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2 = $.BackendlessDB_serverURL;
              if (t2 === "")
                A.throwExpression(A.Exception_Exception("App must be initialised"));
              $async$temp1 = B.C_Utf8Codec;
              $async$goto = 3;
              return A._asyncAwait(A.get0(A._Uri__makeHttpUri("https", t2, "api/users/isvalidusertoken/" + t1, null), null), $async$UserService_isValidLogin);
            case 3:
              // returning from await.
              isLoggedIn = $async$temp1.decode$1(0, $async$result.bodyBytes) === "true";
              if (!isLoggedIn)
                $.BackendlessDB_userToken = "";
              $async$returnValue = isLoggedIn;
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$UserService_isValidLogin, $async$completer);
    },
    Data_data(table) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Map_String_dynamic),
        $async$returnValue, t1, headers, $async$temp1, $async$temp2;
      var $async$Data_data = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = $.BackendlessDB_userToken;
              if (t1 !== "")
                headers.$indexSet(0, "user-token", t1);
              t1 = $.BackendlessDB_serverURL;
              if (t1 === "")
                A.throwExpression(A.Exception_Exception("App must be initialised"));
              $async$temp1 = A;
              $async$temp2 = B.C_Utf8Codec;
              $async$goto = 3;
              return A._asyncAwait(A.get0(A._Uri__makeHttpUri("https", t1, "api/data/" + table, null), headers), $async$Data_data);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1.jsonDecode($async$temp2.decode$1(0, $async$result.bodyBytes));
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$Data_data, $async$completer);
    },
    Data_find(table, query) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Map_String_dynamic),
        $async$returnValue, t1, headers, $async$temp1, $async$temp2;
      var $async$Data_find = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp2 = B.C_Utf8Codec;
              $async$goto = 3;
              return A._asyncAwait(A.get0(A.BackendlessDB_serverQURI("api/data/" + table, query.query), headers), $async$Data_find);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1.jsonDecode($async$temp2.decode$1(0, $async$result.bodyBytes));
              // goto return
      ...
      return A._asyncStartSync($async$Data_find, $async$completer);
    },
    Data_add(table, rows) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Map_String_dynamic),
        $async$returnValue, t1, headers, $async$temp1, $async$temp2;
      var $async$Data_add = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp2 = B.C_Utf8Codec;
              $async$goto = 3;
              return A._asyncAwait(A.post(A._Uri__makeHttpUri("https", t1, "api/data/bulk/" + table, null), B.C_JsonCodec.encode$2$toEncodable(rows, null), headers), $async$Data_add);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1.jsonDecode($async$temp2.decode$1(0, $async$result.bodyBytes));
              // goto return
      ...
      return A._asyncStartSync($async$Data_add, $async$completer);
    },
    Data_update(table, objectID, properties) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Map_String_dynamic),
        $async$returnValue, t1, headers, $async$temp1, $async$temp2;
      var $async$Data_update = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp2 = B.C_Utf8Codec;
              $async$goto = 3;
              return A._asyncAwait(A.put(A._Uri__makeHttpUri("https", t1, "api/data/" + table + "/" + objectID, null), B.C_JsonCodec.encode$2$toEncodable(properties, null), headers), $async$Data_update);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1.jsonDecode($async$temp2.decode$1(0, $async$result.bodyBytes));
              // goto return
      ...
      return A._asyncStartSync($async$Data_update, $async$completer);
    },
    Data_delete(table, objectID) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Map_String_dynamic),
        $async$returnValue, t1, headers, $async$temp1, $async$temp2;
      var $async$Data_delete = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp2 = B.C_Utf8Codec;
              $async$goto = 3;
              return A._asyncAwait(A.$delete0(A._Uri__makeHttpUri("https", t1, "api/data/" + table + "/" + objectID, null), headers), $async$Data_delete);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1.jsonDecode($async$temp2.decode$1(0, $async$result.bodyBytes));
              // goto return
      ...
      return A._asyncStartSync($async$Data_delete, $async$completer);
    },
    Data_count(table, whereClause) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.int),
        $async$returnValue, t3, response, t1, headers, t2;
      var $async$Data_count = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = type$.String;
              headers = A.LinkedHashMap_LinkedHashMap$_literal(["Content-Type", "application/json"], t1, t1);
              t2 = $.BackendlessDB_userToken;
              if (t2 !== "")
                headers.$indexSet(0, "user-token", t2);
              t2 = "api/data/" + table + "/count";
              $async$goto = whereClause === "" ? 3 : 5;
              break;
            case 3:
              // then
              t3 = $.BackendlessDB_serverURL;
              if (t3 === "")
                A.throwExpression(A.Exception_Exception("App must be initialised"));
              $async$goto = 6;
              return A._asyncAwait(A.post(A._Uri__makeHttpUri("https", t3, t2, null), B.C_JsonCodec.encode$2$toEncodable(A.LinkedHashMap_LinkedHashMap$_literal(["distinct", String(false)], t1, t1), null), headers), $async$Data_count);
            case 6:
              // returning from await.
            ...
            case 5:
              // else
              $async$goto = 7;
              return A._asyncAwait(A.post(A.BackendlessDB_serverQURI(t2, A.LinkedHashMap_LinkedHashMap$_literal(["where", whereClause], t1, t1)), B.C_JsonCodec.encode$2$toEncodable(A.LinkedHashMap_LinkedHashMap$_literal(["distinct", String(false)], t1, t1), null), headers), $async$Data_count);
            case 7:
              // returning from await.
              response = $async$result;
            case 4:
              // join
              $async$returnValue = A.int_parse(B.C_Utf8Codec.decode$1(0, response.bodyBytes), null);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$Data_count, $async$completer);
    },
    DataQuery: function DataQuery(t0) {
      this.query = t0;
    },
    MapAttr_attr(_this, m) {
      m.forEach$1(0, new A.MapAttr_attr_closure(_this));
    },
    MapAttr_attr_closure: function MapAttr_attr_closure(t0) {
      this._this = t0;
    },
    MapAttr_attr__closure: function MapAttr_attr__closure(t0, t1) {
      this.key = t0;
      this.val = t1;
    },
    NodeValidatorAllowAll: function NodeValidatorAllowAll() {
    },
    main() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        c, t1, storage, re, isMobile, screenWidth, screenHeight, sel, selButtons, i, t2;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              A.setPageTo(0);
              c = A.getCookie("use_local_storage");
              if (c === "") {
                A.setCookie("use_local_storage", "true", 365);
                c = "true";
              }
              t1 = c === "true";
              $.__usingLocalStorage = t1;
              if (t1) {
                storage = window.localStorage;
                if (storage.getItem("notes") == null)
                  storage.setItem("notes", "[]");
                if (storage.getItem("links") == null)
                  storage.setItem("links", $.$get$__linksPreset());
                if (storage.getItem("todo") == null)
                  storage.setItem("todo", "[]");
                $.$get$__storageCache().$indexSet(0, "notes", A.__getJSON("notes"));
                $.$get$__storageCache().$indexSet(0, "links", A.__getJSON("links"));
                $.$get$__storageCache().$indexSet(0, "todo", A.__getJSON("todo"));
              } else {
              ...
              t1.toString;
              isMobile = re._nativeRegExp.test(t1);
              if (!isMobile) {
                t1 = window.screen;
                screenWidth = t1 == null ? null : t1.width;
                if (screenWidth == null)
                  screenWidth = A._asInt(screenWidth);
                t1 = window.screen;
                screenHeight = t1 == null ? null : t1.height;
                if (screenHeight == null)
                  screenHeight = A._asInt(screenHeight);
              ...
              for (t1 = type$.nullable_dynamic_Function_Event, i = 0; i < selButtons.length; ++i)
                J._addEventListener$3$x(selButtons[i], "click", t1._as(new A.main_closure(i)), null);
              t1 = A.$("#storage-options", null).children$0(0)._elements;
              t2 = J.getInterceptor$asx(t1);
              J.addEventListener$2$x(t2.$index(t1, 0), "click", new A.main_closure0());
              J.addEventListener$2$x(t2.$index(t1, 1), "click", new A.main_closure1());
              if ($.__usingLocalStorage) {
                A.$("#c-footer", null).set$text(0, "@local_terminal");
                A.setupLocalDB();
              } else {
                A.$("#c-footer", null).set$text(0, "@remote_terminal");
                A.setupBackendlessDB();
              }
              A.$("#db-export", null)._on$4("click", type$.void_Function_QueryEvent._as(new A.main_closure2()), null, false);
              // implicit return
    ...
    setupLocalDB() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void);
      var $async$setupLocalDB = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              A._showHide(A.$("#login-header", null)._elements, false);
              A._showHide(A.$("#login-separator", null)._elements, false);
      ...
      return A._asyncStartSync($async$setupLocalDB, $async$completer);
    },
    setupBackendlessDB() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        t1, $async$temp1;
      var $async$setupBackendlessDB = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = type$.void_Function_QueryEvent;
              A.$("#bk-login", null)._on$4("click", t1._as(new A.setupBackendlessDB_closure()), null, false);
              A.$("#bk-logout", null)._on$4("click", t1._as(new A.setupBackendlessDB_closure0()), null, false);
              $async$temp1 = A;
              $async$goto = 2;
              return A._asyncAwait(A.UserService_isValidLogin(), $async$setupBackendlessDB);
            case 2:
              // returning from await.
              if ($async$temp1.boolConversionCheck($async$result)) {
                A._showHide(A.$("#bk-login-form", null)._elements, false);
                A._showHide(A.$("#bk-logout-form", null)._elements, true);
                A.$("#c-footer", null).set$text(0, "@remote_terminal");
              } else {
                A._showHide(A.$("#bk-login-form", null)._elements, true);
                A._showHide(A.$("#bk-logout-form", null)._elements, false);
                A.$("#c-footer", null).set$text(0, "@remote_terminal: unauthorized");
              }
              $async$temp1 = J;
              $async$goto = 3;
              return A._asyncAwait(A.UserService_isValidLogin(), $async$setupBackendlessDB);
      ...
      return A._asyncStartSync($async$setupBackendlessDB, $async$completer);
    },
    setupStorageDB() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        t1;
      var $async$setupStorageDB = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = type$.void_Function_QueryEvent;
              A.$("#newtask", null)._on$4("click", t1._as(new A.setupStorageDB_closure()), null, false);
              A.$("#newnote", null)._on$4("click", t1._as(new A.setupStorageDB_closure0()), null, false);
              A.$("#newnote-cancel", null)._on$4("click", t1._as(new A.setupStorageDB_closure1()), null, false);
              A.$("#newnote-delete", null)._on$4("click", t1._as(new A.setupStorageDB_closure2()), null, false);
              A.$("#newnote-create", null)._on$4("click", t1._as(new A.setupStorageDB_closure3()), null, false);
              A.$("#links-close", null)._on$4("click", t1._as(new A.setupStorageDB_closure4()), null, false);
              A.$("#edit-links", null)._on$4("click", t1._as(new A.setupStorageDB_closure5()), null, false);
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      return A._asyncStartSync($async$setupStorageDB, $async$completer);
    },
    setupSaltcornDB() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        t1, t2, t3, t4, $N, t5, fields, i, field, t6, id, t7, $async$temp1;
      var $async$setupSaltcornDB = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              A._showHide(A.$("#pagesel-tools", null)._elements, true);
              t1 = type$.void_Function_QueryEvent;
              A.$("#tool-addnew", null)._on$4("click", t1._as(new A.setupSaltcornDB_closure()), null, false);
              A.$("#tool-gui-cancel", null)._on$4("click", t1._as(new A.setupSaltcornDB_closure0()), null, false);
              A.$("#tool-gui-confirm", null)._on$4("click", t1._as(new A.setupSaltcornDB_closure1()), null, false);
              t2 = A.$(".c-tools-list", null).children$0(0);
              t2.forEach$1(t2, new A.setupSaltcornDB_closure2());
              t2 = A.$("#tool-searchbar", null);
              t2 = t2.get$first(t2);
              t3 = A.$("#tool-searchbar", null);
              J.replaceWith$1$x(t2, J.clone$1$x(t3.get$first(t3), false));
              t3 = A.$("#tool-tag-searchbar", null);
              t3 = t3.get$first(t3);
              t2 = A.$("#tool-tag-searchbar", null);
              J.replaceWith$1$x(t3, J.clone$1$x(t2.get$first(t2), false));
              $async$goto = 2;
              return A._asyncAwait(A.count("tools"), $async$setupSaltcornDB);
            case 2:
              // returning from await.
              t2 = $async$result / 100 + 1, t3 = type$.Map_String_dynamic, t4 = type$.String, $N = 0;
            case 3:
              // for condition
              if (!($N < t2)) {
                // goto after for
              ...
              t5.$indexSet(0, "pageSize", B.JSInt_methods.toString$0(100));
              t5.$indexSet(0, "offset", B.JSInt_methods.toString$0($N * 100));
              $async$temp1 = J;
              $async$goto = 6;
              return A._asyncAwait(A.get("tools", new A.DataQuery(t5)), $async$setupSaltcornDB);
            case 6:
              // returning from await.
              fields = $async$temp1.$index$asx($async$result, "jsarr");
              for (t5 = J.getInterceptor$asx(fields), i = 0; i < A._asNum(t5.get$length(fields)); ++i) {
                field = t3._as(t5.$index(fields, i));
                t6 = J.getInterceptor$asx(field);
                id = "tools-el-" + A.S(t6.$index(field, "objectId"));
                A.addTool(A._asString(t6.$index(field, "name")), A._asString(t6.$index(field, "description")), A._asString(t6.$index(field, "href")), A._asString(t6.$index(field, "tags")), id);
                t6 = A.$("#tool-searchbar", null);
                t7 = t1._as(new A.setupSaltcornDB_closure3(field, id));
                t6._on$4("input", t7, null, false);
                A.$("#tool-tag-searchbar", null)._on$4("input", t7, null, false);
                A.$("#c-tool-edit-" + id, null)._on$4("click", t1._as(new A.setupSaltcornDB_closure4(field)), null, false);
                A.$("#c-tool-del-" + id, null)._on$4("click", t1._as(new A.setupSaltcornDB_closure5(field, id)), null, false);
              }
            case 4:
              // for update
              ++$N;
      ...
      return A._asyncStartSync($async$setupSaltcornDB, $async$completer);
    },
    addTool($name, desc, href, p_tags, id) {
      var t1, tags, j, tag,
        taglist = p_tags.split(",");
      for (t1 = taglist.length, tags = "", j = 0; j < t1; ++j) {
        tag = taglist[j];
        tags += ' <div class="tool-tag" data="' + tag + '">' + tag + "</div> ";
      }
      A._domManip(A.$(".c-tools-list", null), A.Element_Element$html('    <div class="c-tool" id="' + id + '">\n        <div class="c-tool-name"><a href="' + href + '">' + $name + '</a></div>\n        <div class="c-tool-desc">' + A.fixStringHTML(desc) + '</div>\n        <div class="c-tool-tags">' + tags + '</div>\n        <button class="c-tool-edit button-no-style" id="c-tool-edit-' + id + '"><img src="assets/icons/edit_square.svg"/></button>\n        <button class="c-tool-del button-no-style" id="c-tool-del-' + id + '"><img src="assets/icons/close.svg"/></button>\n    </div>\n    ', null, new A.NodeValidatorAllowAll()), A.dquery___appendFunc$closure());
    },
    setPageTo(page) {
      var _s12_ = "#c-page-home",
        _null = null,
        _s12_0 = "#c-page-tool",
        _s12_1 = "#c-page-link",
        _s12_2 = "#c-page-conf";
      A._showHide(A.$(_s12_, _null)._elements, false);
      A._showHide(A.$("#c-page-work", _null)._elements, false);
      A._showHide(A.$(_s12_0, _null)._elements, false);
      A._showHide(A.$("#c-page-docs", _null)._elements, false);
      A._showHide(A.$(_s12_1, _null)._elements, false);
      A._showHide(A.$(_s12_2, _null)._elements, false);
      if (page === 0)
        A._showHide(A.$(_s12_, _null)._elements, true);
      if (page === 2)
        A._showHide(A.$(_s12_0, _null)._elements, true);
      if (page === 1)
        A._showHide(A.$(_s12_1, _null)._elements, true);
      if (page === 3)
        A._showHide(A.$(_s12_2, _null)._elements, true);
    },
    addBackendlessNotes() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        t1, $async$temp1, $async$temp2;
      var $async$addBackendlessNotes = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = type$.String;
              t1 = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
              t1.$indexSet(0, "pageSize", B.JSInt_methods.toString$0(100));
              t1.$indexSet(0, "sortBy", B.JSArray_methods.join$1(type$.List_String._as(A._setArrayType(["created"], type$.JSArray_String)), ","));
              $async$temp1 = J;
              $async$temp2 = J;
              $async$goto = 2;
              return A._asyncAwait(A.get("notes", new A.DataQuery(t1)), $async$addBackendlessNotes);
            case 2:
              // returning from await.
              $async$temp1.forEach$1$ax($async$temp2.$index$asx($async$result, "jsarr"), new A.addBackendlessNotes_closure());
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      return A._asyncStartSync($async$addBackendlessNotes, $async$completer);
    },
    addBackendlessLinks() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        t1, $async$temp1, $async$temp2, $async$temp3;
      var $async$addBackendlessLinks = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
              t1.$indexSet(0, "pageSize", B.JSInt_methods.toString$0(100));
              t1.$indexSet(0, "sortBy", B.JSArray_methods.join$1(type$.List_String._as(A._setArrayType(["category", "priority"], type$.JSArray_String)), ","));
              $async$temp1 = J;
              $async$temp2 = J;
              $async$temp3 = J;
              $async$goto = 2;
              return A._asyncAwait(A.get("links", new A.DataQuery(t1)), $async$addBackendlessLinks);
            case 2:
              // returning from await.
              $async$temp1.forEach$1$ax($async$temp2.get$reversed$ax($async$temp3.$index$asx($async$result, "jsarr")), new A.addBackendlessLinks_closure());
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      return A._asyncStartSync($async$addBackendlessLinks, $async$completer);
    },
    addLinkTo($name, href, whereid, priority, oid) {
      var escWhereid, t1, linkID, q, t2, _null = null,
        _s21_ = '" type="text" value="';
      $name = A.fixStringHTML($name);
      escWhereid = A.fixStringHTML(A.stringReplaceAllUnchecked(whereid, " ", "-"));
      t1 = oid === "";
      linkID = t1 ? -1 : $.__link_id;
      if (B.JSString_methods.contains$1(href, "<") || B.JSString_methods.contains$1(href, ">")) {
        t1 = window;
        t1.toString;
        B.Window_methods.alert$1(t1, "Link contains invalid symbols!");
        return;
      }
      if (!t1) {
        t1 = ".c-links-" + escWhereid;
        q = A.$(t1, _null);
        if (J.get$length$asx(q._elements) === 0) {
          A._domManip(A.$("#c-page-link", _null), A.Element_Element$html('                <div class="c-links-' + escWhereid + ' c-links-list">\n                    <div class="c-links-title">' + whereid + "</div>\n                </div>\n            ", _null, new A.NodeValidatorAllowAll()), A.dquery___appendFunc$closure());
          q = A.$(t1, _null);
        }
        A._domManip(q, A.Element_Element$html('            <a id="c-link-' + $.__link_id + '" class="c-link button-no-style"  href="' + href + '">\n                ' + $name + "\n            </a>\n        ", _null, new A.NodeValidatorAllowAll()), A.dquery___appendFunc$closure());
        $.__link_id = $.__link_id + 1;
      }
      t1 = "" + linkID;
      A._domManip(A.$("#links-container", _null), A.Element_Element$html('        <div class="links-container-link" id="links-container-' + t1 + '">\n            <input id="links-name-' + t1 + _s21_ + $name + '" placeholder="name" />\n            <input id="links-href-' + t1 + _s21_ + href + '" placeholder="url" />\n            <input id="links-cate-' + t1 + _s21_ + whereid + '" class="icat" placeholder="category" />\n            <input id="links-prio-' + t1 + '" type="number" value="' + priority + '" class="inum" />\n            <button id="link-delete-' + t1 + '" class="button-no-style">delete</button>\n            <button id="link-submit-' + t1 + '" class="button-no-style">submit</button>\n        </div>\n    ', _null, new A.NodeValidatorAllowAll()), A.dquery___appendFunc$closure());
      t2 = type$.void_Function_QueryEvent;
      A.$("#link-submit-" + t1, _null)._on$4("click", t2._as(new A.addLinkTo_closure(oid, linkID)), _null, false);
      A.$("#link-delete-" + t1, _null)._on$4("click", t2._as(new A.addLinkTo_closure0(oid, linkID)), _null, false);
    },
    addBackendlessTodos() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        t1, $async$temp1, $async$temp2;
      var $async$addBackendlessTodos = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp2 = J;
              $async$goto = 2;
              return A._asyncAwait(A.get("todo", new A.DataQuery(t1)), $async$addBackendlessTodos);
            case 2:
              // returning from await.
              $async$temp1.forEach$1$ax($async$temp2.$index$asx($async$result, "jsarr"), new A.addBackendlessTodos_closure());
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      return A._asyncStartSync($async$addBackendlessTodos, $async$completer);
    },
    addTodo($name, $status, oid) {
      var t2, addStatus, t3, t4, todoID,
        _s17_ = "check_box_outline",
        _s14_ = "check_box_line",
        _null = null, t1 = {};
      t1.status = $status;
      $name = A.fixStringHTML($name);
      t1.icon = _s17_;
      ...
      if ($status === "done") {
        t2 = t1.icon = "check_box_complete";
        addStatus = "c-task-done";
      }
      t3 = A.$(".c-tasks", _null);
      t4 = "" + $.__todo_id;
      A._domManip(t3, A.Element_Element$html('        <button id="c-task-' + t4 + '" class="c-task ' + addStatus + '">\n            <img id="c-task-' + t4 + '-img" src="assets/icons/' + t2 + '.svg" />\n            <div>' + $name + "</div>\n        </button>\n    ", _null, new A.NodeValidatorAllowAll()), A.dquery___prependFunc$closure());
      todoID = $.__todo_id;
      A.$("#c-task-" + todoID, _null)._on$4("mouseup", type$.void_Function_QueryEvent._as(new A.addTodo_closure(t1, oid, todoID)), _null, false);
      $.__todo_id = $.__todo_id + 1;
    },
    addNote($name, date, type, oid) {
      var noteID, _null = null;
      $name = A.fixStringHTML($name);
      date = A.fixStringHTML(date);
      type = A.fixStringHTML(type);
      A._domManip(A.$(".c-notes", _null), A.Element_Element$html('        <button class="c-notes-note button-no-style" id="c-notes-note-' + $.__note_id + '">\n            <div class="c-notes-note-text">' + $name + '</div>\n            <div class="c-notes-note-date">' + date + '</div>\n            <div class="c-notes-note-type" note-class="' + type + '">' + type + "</div>\n        </button>\n    ", _null, new A.NodeValidatorAllowAll()), A.dquery___prependFunc$closure());
      noteID = $.__note_id;
      A.$("#c-notes-note-" + noteID, _null)._on$4("click", type$.void_Function_QueryEvent._as(new A.addNote_closure(oid, noteID)), _null, false);
      $.__note_id = $.__note_id + 1;
    },
    fixStringHTML(s) {
      var o = A.stringReplaceAllUnchecked(s, "<", "&lt;");
      o = A.stringReplaceAllUnchecked(o, ">", "&gt;");
      o = A.stringReplaceAllUnchecked(o, "/", "&#47;");
      o = A.stringReplaceAllUnchecked(o, '"', "&apos;");
      return A.stringReplaceAllUnchecked(o, "'", "&quot;");
    },
    monthShort(m) {
      switch (m) {
        case 1:
    ...
    setupBackendlessDB_closure: function setupBackendlessDB_closure() {
    },
    setupBackendlessDB_closure0: function setupBackendlessDB_closure0() {
    },
    setupStorageDB_closure: function setupStorageDB_closure() {
    },
    setupStorageDB_closure0: function setupStorageDB_closure0() {
    },
    setupStorageDB_closure1: function setupStorageDB_closure1() {
    },
    setupStorageDB_closure2: function setupStorageDB_closure2() {
    },
    setupStorageDB_closure3: function setupStorageDB_closure3() {
    },
    setupStorageDB_closure4: function setupStorageDB_closure4() {
    },
    setupStorageDB_closure5: function setupStorageDB_closure5() {
    },
    setupSaltcornDB_closure: function setupSaltcornDB_closure() {
    },
    setupSaltcornDB_closure0: function setupSaltcornDB_closure0() {
    },
    setupSaltcornDB_closure1: function setupSaltcornDB_closure1() {
    },
    setupSaltcornDB_closure2: function setupSaltcornDB_closure2() {
    },
    setupSaltcornDB_closure3: function setupSaltcornDB_closure3(t0, t1) {
      this.field = t0;
      this.id = t1;
    },
    setupSaltcornDB_closure4: function setupSaltcornDB_closure4(t0) {
      this.field = t0;
    },
    setupSaltcornDB_closure5: function setupSaltcornDB_closure5(t0, t1) {
      this.field = t0;
      this.id = t1;
    },
    addBackendlessNotes_closure: function addBackendlessNotes_closure() {
    },
    addBackendlessLinks_closure: function addBackendlessLinks_closure() {
    },
    addLinkTo_closure: function addLinkTo_closure(t0, t1) {
      this.oid = t0;
      this.linkID = t1;
    },
    addLinkTo_closure0: function addLinkTo_closure0(t0, t1) {
      this.oid = t0;
      this.linkID = t1;
    },
    addBackendlessTodos_closure: function addBackendlessTodos_closure() {
    },
    addTodo_closure: function addTodo_closure(t0, t1, t2) {
      this._box_0 = t0;
      this.oid = t1;
      this.todoID = t2;
    },
    addNote_closure: function addNote_closure(t0, t1) {
      this.oid = t0;
      this.noteID = t1;
    },
    __link($name, href, category, priority) {
      var t1 = $.__link_idx + 1;
      $.__link_idx = t1;
      return '{\n        "created": 0,\n        "objectId": "asm' + t1 + '",\n        "name": "' + $name + '",\n        "href": "' + href + '",\n        "category": "' + category + '",\n        "priority": ' + priority + "\n    }";
    },
    add(table, val) {
      var $async$goto = 0,
        ...
        $async$returnValue, t1, j, $async$temp1, $async$temp2, $async$temp3;
      var $async$add = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = $.__usingLocalStorage ? 3 : 5;
              break;
            case 3:
              // then
              val.$indexSet(0, "created", Date.now());
              val.$indexSet(0, "objectId", J.toString$0$(val.$index(0, "created")) + B.JSInt_methods.toString$0($.__msecHash));
              $.__msecHash = $.__msecHash + 1;
              t1 = $.$get$__storageCache().$index(0, table);
              t1 = t1 == null ? null : J.$index$asx(t1, "jsarr");
              J.add$1$ax(type$.List_dynamic._as(t1), val);
              t1 = $.$get$__storageCache().$index(0, table);
              j = B.C_JsonCodec.encode$2$toEncodable(t1 == null ? type$.Map_String_dynamic._as(t1) : t1, null);
              window.localStorage.setItem(table, j);
              $async$returnValue = type$.FutureOr_String._as(val.$index(0, "objectId"));
              // goto return
              $async$goto = 1;
              break;
              // goto join
            ...
            case 5:
              ...
              $async$temp3 = J;
              $async$goto = 6;
              return A._asyncAwait(A.Data_add(table, A._setArrayType([val], type$.JSArray_Map_String_dynamic)), $async$add);
            case 6:
              // returning from await.
              $async$returnValue = $async$temp1._as($async$temp2.$index$asx($async$temp3.$index$asx($async$result, "jsarr"), 0));
              // goto return
              $async$goto = 1;
              break;
            case 4:
      ...
      return A._asyncStartSync($async$add, $async$completer);
    },
    update(table, id, val) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
      ...
      var $async$update = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = $.__usingLocalStorage ? 2 : 4;
              break;
            case 2:
              // then
              t1 = $.$get$__storageCache().$index(0, table);
              ...
              for (t2 = J.getInterceptor$asx(t1), i = 0; i < t2.get$length(t1); ++i)
                if (J.$eq$(J.$index$asx(t2.$index(t1, i), "objectId"), id)) {
                  J.addAll$1$ax(type$.Map_String_dynamic._as(t2.$index(t1, i)), val);
                  break;
                }
              t1 = $.$get$__storageCache().$index(0, table);
              j = B.C_JsonCodec.encode$2$toEncodable(t1 == null ? type$.Map_String_dynamic._as(t1) : t1, null);
            ...
            case 4:
              // else
              $async$goto = 5;
              return A._asyncAwait(A.Data_update(table, id, val), $async$update);
            case 5:
              // returning from await.
            case 3:
              // join
    ...
    get(table, query) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Map_String_dynamic),
        $async$returnValue, j;
      var $async$get = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              // then
              j = $.$get$__storageCache().$index(0, table);
              if (j == null)
                j = type$.Map_String_dynamic._as(j);
              if (query != null)
                J.sort$1$ax(type$.List_dynamic._as(J.$index$asx(j, "jsarr")), new A.get_closure(query));
              $async$returnValue = j;
              // goto return
              $async$goto = 1;
              break;
            ...
            case 5:
              // else
              $async$goto = query != null ? 6 : 8;
              break;
            case 6:
              // then
              $async$goto = 9;
              return A._asyncAwait(A.Data_find(table, query), $async$get);
            case 9:
              // returning from await.
            ...
            case 8:
              // else
              $async$goto = 10;
              return A._asyncAwait(A.Data_data(table), $async$get);
            case 10:
              // returning from await.
              $async$returnValue = $async$result;
              // goto return
      ...
      return A._asyncStartSync($async$get, $async$completer);
    },
    $delete(table, id) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        t1, t2, idx, t3, i, j;
      var $async$$delete = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            ...
            case 2:
              ...
              i = 0;
              while (true) {
                if (!(i < t3.get$length(t1))) {
                  idx = -1;
                  break;
                }
                if (J.$eq$(J.$index$asx(t3.$index(t1, i), "objectId"), id)) {
                  idx = i;
                  break;
                }
                ++i;
              ...
              if (idx !== -1) {
                t1 = $.$get$__storageCache().$index(0, table);
                J.removeAt$1$ax(t2._as(t1 == null ? null : J.$index$asx(t1, "jsarr")), idx);
              }
              t1 = $.$get$__storageCache().$index(0, table);
              j = B.C_JsonCodec.encode$2$toEncodable(t1 == null ? type$.Map_String_dynamic._as(t1) : t1, null);
              window.localStorage.setItem(table, j);
            ...
            case 4:
              // else
              $async$goto = 5;
              return A._asyncAwait(A.Data_delete(table, id), $async$$delete);
            case 5:
              // returning from await.
            case 3:
              // join
      ...
      return A._asyncStartSync($async$$delete, $async$completer);
    },
    count(table) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.int),
        $async$returnValue, t1;
      var $async$count = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              t1 = $.$get$__storageCache().$index(0, table);
              t1 = t1 == null ? null : J.$index$asx(t1, "jsarr");
              $async$returnValue = J.get$length$asx(type$.List_dynamic._as(t1));
              // goto return
              $async$goto = 1;
              break;
              // goto join
            ...
            case 5:
              // else
              $async$goto = 6;
              return A._asyncAwait(A.Data_count(table, ""), $async$count);
            case 6:
              // returning from await.
              $async$returnValue = $async$result;
              // goto return
      ...
      return A._asyncStartSync($async$count, $async$completer);
    },
    exportDB() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        tools, notes, links, $async$temp1, $async$temp2;
      var $async$exportDB = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A.getTableData("tools"), $async$exportDB);
            case 2:
              // returning from await.
              tools = $async$result;
              $async$goto = 3;
              return A._asyncAwait(A.getTableData("notes"), $async$exportDB);
            case 3:
              // returning from await.
              notes = $async$result;
              $async$goto = 4;
              return A._asyncAwait(A.getTableData("links"), $async$exportDB);
            case 4:
              // returning from await.
              links = $async$result;
              $async$temp1 = A;
              $async$temp2 = "homepage-export-todo.csv";
              $async$goto = 5;
              return A._asyncAwait(A.getTableData("todo"), $async$exportDB);
            case 5:
              // returning from await.
              $async$temp1.exportFile($async$temp2, $async$result);
              A.exportFile("homepage-export-tools.csv", tools);
              A.exportFile("homepage-export-notes.csv", notes);
              A.exportFile("homepage-export-links.csv", links);
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      return A._asyncStartSync($async$exportDB, $async$completer);
    },
    exportFile($name, data) {
      ...
      var $async$exportFile = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              for (t1 = type$.Iterable_dynamic, t2 = J.get$iterator$ax(t1._as(J.$index$asx(data, "jsarr"))), csv = "", didHeader = false; t2.moveNext$0();) {
                field = t2.get$current(t2);
                if (!didHeader) {
                  for (t3 = J.get$iterator$ax(t1._as(J.get$keys$x(field))); t3.moveNext$0();)
                    csv += A._asString(J.$add$ansx(t3.get$current(t3), ","));
              ...
              A.UriData__writeUri("text/plain", null, null, buffer, indices);
              B.JSArray_methods.add$1(indices, buffer._contents.length);
              buffer._contents += ",";
              A.UriData__uriEncodeBytes(B.List_42A, B.C_AsciiCodec.encode$1(csv), buffer);
              t1 = buffer._contents;
              link.setAttribute("href", new A.UriData(t1.charCodeAt(0) == 0 ? t1 : t1, indices, null).get$uri().get$_text());
      ...
      return A._asyncStartSync($async$exportFile, $async$completer);
    },
    getTableData(table) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Map_String_dynamic),
        $async$returnValue, t1, j, t2, $N, t3, fields, $async$temp1;
      var $async$getTableData = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              // then
              $async$returnValue = A.get(table, null);
              // goto return
              $async$goto = 1;
              break;
              // goto join
            ...
            case 5:
              // else
              t1 = type$.String;
              j = A.LinkedHashMap_LinkedHashMap$_literal(["jsarr", []], t1, type$.dynamic);
              $async$goto = 6;
              return A._asyncAwait(A.count(table), $async$getTableData);
            case 6:
              // returning from await.
              t2 = $async$result / 100 + 1, $N = 0;
            case 7:
              // for condition
              if (!($N < t2)) {
                // goto after for
              ...
              t3.$indexSet(0, "pageSize", B.JSInt_methods.toString$0(100));
              t3.$indexSet(0, "offset", B.JSInt_methods.toString$0($N * 100));
              $async$temp1 = J;
              $async$goto = 10;
              return A._asyncAwait(A.get(table, new A.DataQuery(t3)), $async$getTableData);
            case 10:
              // returning from await.
              fields = $async$temp1.$index$asx($async$result, "jsarr");
              j.$indexSet(0, "jsarr", J.$add$ansx(j.$index(0, "jsarr"), fields));
            case 8:
              // for update
              ++$N;
              // goto for condition
      ...
      return A._asyncStartSync($async$getTableData, $async$completer);
    },
    __getJSON(table) {
      var j = window.localStorage.getItem(table);
      return A.jsonDecode(j == null ? A._asString(j) : j);
    },
    get_closure: function get_closure(t0) {
      this.q = t0;
    },
    max(a, b, $T) {
    ...
    setCookie(cname, cvalue, exdays) {
      var t1 = B.JSInt_methods.toString$0(exdays * 24 * 60 * 60),
        t2 = document;
      t2.toString;
      B.HtmlDocument_methods.set$cookie(t2, cname + "=" + cvalue + ";" + ("max-age=" + t1) + ";path=/");
    },
    getCookie(cname) {
      var ca, i, c, t2,
        $name = cname + "=",
      ...
      if (t1 == null)
        t1 = A._asString(t1);
      ca = A._Uri__uriDecode(t1, 0, t1.length, B.C_Utf8Codec, false).split(";");
      for (t1 = ca.length, i = 0; i < t1; ++i) {
        c = ca[i];
        while (true) {
          t2 = c.length;
          if (!(t2 > 0 && c[0] === " "))
            break;
          c = B.JSString_methods.substring$1(c, 1);
        }
        if (B.JSString_methods.indexOf$1(c, $name) === 0)
          return B.JSString_methods.substring$2(c, $name.length, t2);
      }
      return "";
    }
  },
  ...
  A.Instantiation2.prototype = {
    ...
    call$0() {
      return this._genericClosure.call$2$0(this.$ti._rest[0], this.$ti._rest[1]);
    },
    $signature() {
      return A.instantiatedGenericFunctionType(A.closureFunctionType(this._genericClosure), this.$ti);
    }
  ...
  A.Stream_contains_closure0.prototype = {
    call$1(element) {
      var _this = this,
        ...
        t2 = _this.future;
      A._runUserCode(new A.Stream_contains__closure(A._instanceType(_this.$this)._eval$1("Stream.T")._as(element), _this.needle), new A.Stream_contains__closure0(t1, t2), A._cancelAndErrorClosure(t1, t2), type$.bool);
    },
    $signature() {
  ...
  A.MapBase.prototype = {
    ...
    addAll$1(receiver, other) {
      A.instanceType(receiver)._eval$1("Map<MapBase.K,MapBase.V>")._as(other).forEach$1(0, new A.MapBase_addAll_closure(receiver));
    },
  ...
  A.SetBase.prototype = {
    ...
    toList$1$growable(_, growable) {
      return A.List_List$of(this, true, A._instanceType(this)._eval$1("SetBase.E"));
    },
    toList$0(_) {
      return this.toList$1$growable(0, true);
    },
    ...
    forEach$1(_, f) {
      var t1, t2, element;
      A._instanceType(this)._eval$1("~(SetBase.E)")._as(f);
  ...
  A.AccessibleNodeList.prototype = {
    ...
    remove$1(receiver, index) {
      return receiver.remove(A._asInt(index));
    }
  };
  ...
  A.CacheStorage.prototype = {
    keys$0(receiver) {
      var t1 = receiver.keys();
      t1.toString;
      return A.promiseToFuture(t1, type$.dynamic);
    }
  };
  ...
  A.Element.prototype = {
    ...
    matches$1(receiver, selectors) {
      var t1 = !!receiver.matches;
      t1.toString;
      if (t1) {
        t1 = receiver.matches(selectors);
        t1.toString;
        return t1;
      } else {
        t1 = !!receiver.webkitMatchesSelector;
        t1.toString;
        if (t1) {
          t1 = receiver.webkitMatchesSelector(selectors);
          t1.toString;
          return t1;
        } else {
          t1 = !!receiver.mozMatchesSelector;
          t1.toString;
          if (t1) {
            t1 = receiver.mozMatchesSelector(selectors);
            t1.toString;
            return t1;
          } else {
            t1 = !!receiver.msMatchesSelector;
            t1.toString;
            if (t1) {
              ...
              t1 = !!receiver.oMatchesSelector;
              t1.toString;
              if (t1) {
                t1 = receiver.oMatchesSelector(selectors);
                t1.toString;
                return t1;
              } else
                throw A.wrapException(A.UnsupportedError$("Not supported on this platform"));
            }
          }
        }
      }
    ...
    _querySelectorAll$1(receiver, selectors) {
      var t1 = receiver.querySelectorAll(selectors);
      t1.toString;
      return t1;
    },
    $isElement: 1
  ...
  A.Event.prototype = {
    get$defaultPrevented(receiver) {
      var t1 = receiver.defaultPrevented;
      t1.toString;
      return t1;
    },
    get$target(receiver) {
    ...
    get$type(receiver) {
      var t1 = receiver.type;
      t1.toString;
      return t1;
    },
    preventDefault$0(receiver) {
  ...
  A.EventTarget.prototype = {
    addEventListener$3(receiver, type, listener, useCapture) {
      this._addEventListener$3(receiver, type, type$.nullable_dynamic_Function_Event._as(listener), useCapture);
    },
    ...
    removeEventListener$3(receiver, type, listener, useCapture) {
      this._removeEventListener$3(receiver, type, type$.nullable_dynamic_Function_Event._as(listener), useCapture);
    },
  ...
  A.FocusEvent.prototype = {
    get$relatedTarget(receiver) {
      return A._convertNativeToDart_EventTarget(receiver.relatedTarget);
    }
  };
  ...
  A.Node.prototype = {
    ...
    clone$1(receiver, deep) {
      var t1 = receiver.cloneNode(deep);
      t1.toString;
      return t1;
    },
    contains$1(receiver, other) {
  ...
  A.PaymentInstruments.prototype = {
    keys$0(receiver) {
      var t1 = receiver.keys();
      t1.toString;
      return A.promiseToFuture(t1, type$.List_dynamic);
    }
  };
  A.Plugin.prototype = {
    get$length(receiver) {
  ...
  A._DOMWindowCrossFrame.prototype = {
    addEventListener$3(_, type, listener, useCapture) {
      type$.nullable_dynamic_Function_Event._as(listener);
      return A.throwExpression(A.UnsupportedError$(string$.You_ca));
    },
  ...
  A.CssClassSetImpl.prototype = {
    ...
    toList$1$growable(_, growable) {
      var t1 = this.readClasses$0();
      return A.List_List$of(t1, true, A._instanceType(t1)._eval$1("SetBase.E"));
    },
    toList$0(_) {
      return this.toList$1$growable(0, true);
    },
    skip$1(_, n) {
      var t1 = this.readClasses$0();
      return A.SkipIterable_SkipIterable(t1, n, A._instanceType(t1)._eval$1("SetBase.E"));
    },
    elementAt$1(_, index) {
  ...
  A.SvgElement.prototype = {
    ...
    click$0(receiver) {
      throw A.wrapException(A.UnsupportedError$("Cannot invoke click SVG."));
    },
    $isSvgElement: 1
  };
  ...
  A.CanonicalizedMap.prototype = {
    ...
    putIfAbsent$2(_, key, ifAbsent) {
      ...
      return _this._base.putIfAbsent$2(0, _this._canonicalize.call$1(key), new A.CanonicalizedMap_putIfAbsent_closure(_this, key, ifAbsent)).value;
    },
    remove$1(_, key) {
      var pair, _this = this;
      if (!_this._isValidKey$1(key))
  ...
  A._Storage.prototype = {
    $get$2(_, owner, key) {
      var space,
        t1 = owner == null ? type$.Object._as(owner) : owner;
      A.Expando__checkType(t1);
      space = this._cache._jsWeakMap.get(t1);
      return space == null ? null : J.$index$asx(space, key);
    },
    getSpace$1(owner) {
      var space,
        t1 = this._cache;
      A.Expando__checkType(owner);
      space = t1._jsWeakMap.get(owner);
      if (space == null) {
        space = A.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.dynamic);
        t1.$indexSet(0, owner, space);
      }
      return space;
    },
    remove$2(_, owner, key) {
      var t1, space, t2;
      type$.Node._as(owner);
      t1 = this._cache;
      A.Expando__checkType(owner);
  ...
  A._Query.prototype = {
    ...
    find$1(_, selector) {
      var _this = this,
        s = _this.get$selector() != null ? A.S(_this.get$selector()) + " " + selector : selector,
        t1 = _this.pushStack$1(_this._queryAll$1(selector));
      t1._selector = s;
      return t1;
    },
    pushStack$1(elems) {
      var t1 = new A._ElementQuery(type$.List_Element._as(elems));
      t1.set$_prevObject(this);
      t1._dquery$_context = this._dquery$_context;
      return t1;
    },
    _on$4(types, handler, selector, one) {
      type$.nullable_void_Function_QueryEvent._as(handler);
      this.forEach$1(this, new A._Query__on_closure(types, handler, selector));
    },
    set$_prevObject(_prevObject) {
      type$.nullable__Query_EventTarget._as(_prevObject);
    },
    $isEfficientLengthIterable: 1,
    $isIterable: 1,
    $isList: 1
  };
  A._Query__on_closure.prototype = {
    call$1(t) {
      return A._EventUtil_add(type$.EventTarget._as(t), this.types, this.h, this.selector);
    },
    $signature: 45
  };
  A._DocumentQuery.prototype = {
    $index(_, index) {
      A._asInt(index);
      return this._doc;
    },
    $indexSet(_, index, value) {
      type$.nullable_HtmlDocument._as(value);
      if (index !== 0 || value == null)
        throw A.wrapException(A.ArgumentError$("" + index + ": " + A.S(value), null));
      this._doc = value;
    },
    get$length(_) {
      return 1;
    ...
    set$length(_, $length) {
      if ($length !== 1)
        throw A.wrapException(A.UnsupportedError$("fixed length"));
    },
    _queryAll$1(selector) {
      var t1 = this._doc,
        t2 = type$.Element;
      A.checkTypeBound(t2, t2, "T", "querySelectorAll");
      t1 = t1.querySelectorAll(selector);
      t1.toString;
      return new A._FrozenElementList(t1, type$._FrozenElementList_Element);
    }
  };
  A._ElementQuery.prototype = {
    get$selector() {
      return this._selector;
    },
    $index(_, index) {
      return J.$index$asx(this._elements, A._asInt(index));
    },
    get$length(_) {
      return J.get$length$asx(this._elements);
    },
    $indexSet(_, index, value) {
      J.$indexSet$ax(this._elements, index, type$.Element._as(value));
    },
    set$length(_, $length) {
    ...
    _queryAll$1(selector) {
      ...
      switch (t2.get$length(t1)) {
        ...
        case 1:
          t1 = this.get$first(this);
          t2 = type$.Element;
          A.checkTypeBound(t2, t2, "T", _s16_);
          return new A._FrozenElementList(J._querySelectorAll$1$x(t1, selector), type$._FrozenElementList_Element);
        default:
          matched = A._setArrayType([], type$.JSArray_Element);
          for (t1 = t2.get$iterator(t1), t2 = type$.Element, t3 = type$._FrozenElementList_Element; t1.moveNext$0();) {
            t4 = t1.get$current(t1);
            A.checkTypeBound(t2, t2, "T", _s16_);
            t4 = t4.querySelectorAll(selector);
            t4.toString;
            B.JSArray_methods.addAll$1(matched, new A._FrozenElementList(t4, t3));
          }
          t1 = A.LinkedHashSet_LinkedHashSet$from(matched, t2);
          return A.List_List$of(t1, true, A._instanceType(t1)._eval$1("SetBase.E"));
      }
    },
    children$0(_) {
      ...
      for (t1 = J.get$iterator$ax(this._elements); t1.moveNext$0();)
        for (t2 = J.get$children$x(t1.get$current(t1)), t2 = t2.get$iterator(t2), t3 = t2.$ti._precomputed1; t2.moveNext$0();) {
          t4 = t2._current;
          if (t4 == null)
            t4 = t3._as(t4);
          B.JSArray_methods.add$1(results, t4);
        }
      return this.pushStack$1(results);
    },
    addClass$1($name) {
      var t1;
      for (t1 = J.get$iterator$ax(this._elements); t1.moveNext$0();)
        J.get$classes$x(t1.get$current(t1)).add$1(0, $name);
    },
    removeClass$1($name) {
      var t1;
      for (t1 = J.get$iterator$ax(this._elements); t1.moveNext$0();)
        J.get$classes$x(t1.get$current(t1)).remove$1(0, $name);
    },
    clone$0(_) {
      var t1 = J.map$1$1$ax(this._elements, new A._ElementQuery_clone_closure(), type$.Element);
      return this.pushStack$1(A.List_List$of(t1, true, t1.$ti._eval$1("ListIterable.E")));
    },
    detach$0(_) {
      var t1 = A.List_List$from(this._elements, true, type$.Element);
      return B.JSArray_methods.forEach$1(t1, new A._ElementQuery_detach_closure(true));
    },
    set$text(_, value) {
      J.forEach$1$ax(this._elements, new A._ElementQuery_text_closure(value));
    },
    $isElementQuery: 1
  };
  A._ElementQuery_clone_closure.prototype = {
    call$1(e) {
      var clone,
        t1 = type$.Element;
      t1._as(e);
      clone = t1._as(J.clone$1$x(e, true));
      return clone;
    },
    $signature: 46
  };
  A._ElementQuery_detach_closure.prototype = {
    call$1(e) {
      type$.Element._as(e);
      A._cleanData(e);
  ...
  A._ElementQuery_text_closure.prototype = {
    call$1(e) {
      var t1;
      type$.Element._as(e);
      J.get$children$x(e).clear$0(0);
      t1 = document.createTextNode(this.value);
      t1.toString;
      e.appendChild(t1).toString;
      return null;
    },
    $signature: 5
  };
  A._EventUtil_add_closure.prototype = {
    call$0() {
      return new A._EventUtil_add__closure(this._box_0, this.eventTarget);
    },
    $signature: 47
  };
  A._EventUtil_add__closure.prototype = {
    call$1(e) {
      if (e == null || $._EventUtil__triggered !== this._box_0.type)
        A._EventUtil_dispatch(this.eventTarget, new A.QueryEvent(type$.nullable_Event._as(e), null), this._box_0.type);
    },
    $signature: 7
  };
  A._EventUtil_add_closure0.prototype = {
    call$0() {
      var _this = this,
        t1 = _this._box_0,
        t2 = t1.special.setup;
      if (t2 == null || !A.boolConversionCheck(t2.call$1(_this.eventTarget)))
        J.addEventListener$3$x(_this.eventTarget, t1.type, _this.eventHandle, false);
      t1 = type$.JSArray__HandleObject;
      return new A._HandleObjectContext(A._setArrayType([], t1), A._setArrayType([], t1));
    },
    $signature: 48
  };
  A._EventUtil_remove_closure.prototype = {
    call$1(handleObj) {
      var t1, res, t2, _this = this;
      type$._HandleObject._as(handleObj);
      t1 = _this._box_0;
      res = false;
      if (_this.mappedTypes || _this.origType === handleObj.origType) {
        t2 = _this.handler;
        if (t2 == null || J.$eq$(t2, handleObj.handler)) {
          t1 = t1.namespaces.length === 0 || A.boolConversionCheck(new A._EventUtil_remove_closure_matchNamespaces(t1, handleObj).call$0());
          res = t1;
        }
      }
      return res;
  ...
  A._EventUtil_remove_closure_matchNamespaces.prototype = {
    call$0() {
      var t1, t2, t3, _i, ns;
      for (t1 = this.handleObj.namespace.split("."), t2 = t1.length, t3 = this._box_0, _i = 0; _i < t2; ++_i) {
        ns = t1[_i];
        if (B.JSArray_methods.contains$1(t3.namespaces, ns))
          return true;
      }
      return false;
    },
  ...
  A._EventUtil_handlers_closure.prototype = {
    call$0() {
      var t3, _this = this,
        t1 = _this._box_0,
        t2 = t1.cur;
      if (type$.Element._is(t2)) {
        t3 = _this.sel;
        if (_this.handleObj.needsContext) {
          t2 = A.$(t3, _this.elem);
          t1 = t2.contains$1(t2, t1.cur);
        } else
          t1 = J.matches$1$x(t2, t3);
      } else
        t1 = false;
      return t1;
    },
  ...
  A._HandleObjectContext.prototype = {
    get$delegates() {
  ...
  A._HandlerQueueEntry.prototype = {
    get$handlers() {
      return this.handlers;
    }
  };
  A._HandleObject.prototype = {};
  A._SpecialEventHandler.prototype = {};
  A._SPECIAL_HANDLINGS_closure.prototype = {
    call$2(elem, data) {
      elem.click$0(0);
      return false;
    },
  ...
  A._SPECIAL_HANDLINGS_closure0.prototype = {
    call$2(elem, data) {
      A._activeElement();
      elem.focus$0(0);
      return false;
  ...
  A._SPECIAL_HANDLINGS_closure1.prototype = {
    call$2(elem, data) {
      A._activeElement();
      return true;
    },
  ...
  A._initMouseenterleave_closure.prototype = {
    call$1($event) {
      var target = type$.Node._as($event._currentTarget),
        related = type$.nullable_Node._as($event.get$relatedTarget(0)),
        handleObj = $event._handleObj;
      if (related !== target && !J.contains$1$asx(target, related)) {
  ...
  A._initNotSupportFocusinBubbles_closure.prototype = {
    call$1($event) {
      var e;
      type$.Event._as($event);
      e = new A.QueryEvent(null, this.fix);
      e._target = J.get$target$x($event);
      A._EventUtil_triggerEvent(e);
      if (e.get$defaultPrevented(0))
        new A.QueryEvent($event, null).preventDefault$0(0);
      return null;
    },
    $signature: 52
  };
  A._initNotSupportFocusinBubbles_closure0.prototype = {
    call$1(_) {
      var t1;
      if (this._box_0.attaches++ === 0) {
        t1 = document;
        t1.toString;
        B.HtmlDocument_methods.addEventListener$3(t1, this.orig, this.handler, true);
      }
      return true;
    },
    $signature: 28
  };
  A._initNotSupportFocusinBubbles_closure1.prototype = {
    call$1(_) {
      var t1;
      if (--this._box_0.attaches === 0) {
        t1 = document;
        t1.toString;
        B.HtmlDocument_methods.removeEventListener$3(t1, this.orig, this.handler, true);
      }
      return true;
    },
    $signature: 28
  ...
  A.QueryEvent.prototype = {
    ...
    get$target(_) {
      var _this = this,
        t1 = _this._target;
      if (t1 == null && _this.originalEvent != null) {
        t1 = _this.originalEvent;
        t1.toString;
        t1 = _this._target = J.get$target$x(t1);
        if (type$.Text._is(t1)) {
          t1 = t1.parentNode;
          _this._target = t1;
        }
    ...
    get$relatedTarget(_) {
      return this._safeOriginal$1$1(new A.QueryEvent_relatedTarget_closure(), type$.EventTarget);
    },
    get$button(_) {
      return A._asInt(this._safeOriginal$1$1(new A.QueryEvent_button_closure(), type$.dynamic));
    },
    _safeOriginal$1$2(f, defaultValue, $T) {
      var t1, exception;
      $T._eval$1("0(@)")._as(f);
      $T._eval$1("0?")._as(defaultValue);
      t1 = this.originalEvent;
      if (t1 != null)
        try {
          t1 = f.call$1(t1);
    ...
    _safeOriginal$1$1(f, $T) {
      return this._safeOriginal$1$2(f, null, $T);
    },
    get$defaultPrevented(_) {
      var t1 = this._defaultPrevented;
      return A._asBool(t1 == null ? this._safeOriginal$1$2(new A.QueryEvent_defaultPrevented_closure(), false, type$.dynamic) : t1);
    },
    preventDefault$0(_) {
      var t1;
    ...
    set$_handleObj(_handleObj) {
      this._handleObj = type$.nullable__HandleObject._as(_handleObj);
    },
    $isJSObject: 1,
    $isEvent: 1
  };
  A.QueryEvent_relatedTarget_closure.prototype = {
    call$1(e) {
      return type$.EventTarget._as(J.get$relatedTarget$x(e));
    },
    $signature: 54
  };
  A.QueryEvent_button_closure.prototype = {
    call$1(e) {
      return J.get$button$x(e);
    },
    $signature: 6
  };
  A.QueryEvent_defaultPrevented_closure.prototype = {
    call$1(e) {
      return J.get$defaultPrevented$x(e);
    },
    $signature: 6
  };
  A._appendFunc_closure.prototype = {
    call$1(elem) {
      var t1 = this.ref.appendChild(type$.Element._as(elem));
      t1.toString;
      return t1;
    },
    $signature: 5
  };
  A._prependFunc_closure.prototype = {
    call$1(elem) {
      return J.insertBefore$2$x(this.ref, type$.Element._as(elem), this.before);
    },
    $signature: 5
  };
  A.__DocumentQuery__Query_ListMixin.prototype = {};
  A.__ElementQuery__Query_ListMixin.prototype = {};
  A.get_closure0.prototype = {
    call$1(client) {
  ...
  A.Request.prototype = {
    get$encoding(_) {
      var t1, t2, _this = this;
      if (_this.get$_contentType() == null || !_this.get$_contentType().parameters._collection$_map.containsKey$1(0, "charset"))
  ...
  A._EventStream.prototype = {
    listen$4$cancelOnError$onDone$onError(onData, cancelOnError, onDone, onError) {
      ...
      t1._eval$1("~(1)?")._as(onData);
      type$.nullable_void_Function._as(onDone);
      return A._EventStreamSubscription$(this._streams$_target, this._eventType, onData, false, t1._precomputed1);
    }
  };
  A._EventStreamSubscription.prototype = {
    ...
    _tryResume$0() {
      var t1 = this._onData;
      if (t1 != null)
        this._streams$_target.addEventListener(this._eventType, t1, false);
    },
    _unlisten$0() {
      var t1 = this._onData;
      if (t1 != null)
  ...
  A.DataQuery.prototype = {};
  A.MapAttr_attr_closure.prototype = {
    call$2(key, val) {
      var t1 = this._this;
      t1.forEach$1(t1, new A.MapAttr_attr__closure(A._asString(key), type$.Object._as(val)));
    },
    $signature: 73
  };
  A.MapAttr_attr__closure.prototype = {
    call$1(e) {
      type$.Element._as(e).setAttribute(this.key, this.val);
      return null;
    },
    $signature: 5
  };
  A.NodeValidatorAllowAll.prototype = {
    allowsAttribute$3(element, attributeName, value) {
      return true;
    },
    allowsElement$1(element) {
  ...
  A.main_closure1.prototype = {
    call$1(e) {
      type$.Event._as(e);
      A.setCookie("use_local_storage", "false", 365);
      type$.Location._as(window.location).reload();
    },
    $signature: 17
  };
  ...
  A.setupBackendlessDB_closure.prototype = {
    call$1(e) {
      return this.$call$body$setupBackendlessDB_closure0(type$.QueryEvent._as(e));
    },
    $call$body$setupBackendlessDB_closure0(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              uname = t2._as(t1.get$first(t1)).value;
              t1 = A.$("#bk-passw", null);
              passw = t2._as(t1.get$first(t1)).value;
              $async$goto = passw != null && uname != null ? 2 : 3;
              break;
            case 2:
              // then
              $async$goto = passw !== "" && uname !== "" ? 4 : 5;
              break;
            case 4:
              // then
              $async$goto = 6;
            ...
            case 6:
              // returning from await.
              j = $async$result;
              if (J.containsKey$1$x(j, "errorData"))
                A.printString(A.S(j));
            case 5:
              // join
            case 3:
              ...
              $async$temp1 = A;
              $async$goto = 7;
              return A._asyncAwait(A.UserService_isValidLogin(), $async$call$1);
            case 7:
              // returning from await.
              if ($async$temp1.boolConversionCheck($async$result)) {
                A._showHide(A.$("#bk-login-form", null)._elements, false);
  ...
  A.setupBackendlessDB_closure0.prototype = {
    call$1(e) {
      return this.$call$body$setupBackendlessDB_closure(type$.QueryEvent._as(e));
    },
    $call$body$setupBackendlessDB_closure(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, t1;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = window;
              t1.toString;
              if (!B.Window_methods.confirm$1(t1, "Do you want to log out?")) {
                // goto return
                $async$goto = 1;
                break;
              }
              $async$goto = 3;
              return A._asyncAwait(A.UserService_logout(), $async$call$1);
            case 3:
              // returning from await.
              A._showHide(A.$("#bk-login-form", null)._elements, true);
              A._showHide(A.$("#bk-logout-form", null)._elements, false);
  ...
  A.setupStorageDB_closure.prototype = {
    call$1(e) {
      return this.$call$body$setupStorageDB_closure3(type$.QueryEvent._as(e));
    },
    $call$body$setupStorageDB_closure3(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $prompt, $async$temp1, $async$temp2;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $prompt = A._asStringQ($.$get$_context().callMethod$2("prompt", ["Input new task"]));
              ...
              $async$temp2 = $prompt;
              $async$goto = 3;
              return A._asyncAwait(A.add("todo", A.LinkedHashMap_LinkedHashMap$_literal(["name", $prompt, "status", "todo"], type$.String, type$.dynamic)), $async$call$1);
            case 3:
              // returning from await.
              $async$temp1.addTodo($async$temp2, "todo", $async$result);
            case 1:
              // return
              return A._asyncReturn($async$returnValue, $async$completer);
          }
  ...
  A.setupStorageDB_closure0.prototype = {
    call$1(e) {
      return this.$call$body$setupStorageDB_closure2(type$.QueryEvent._as(e));
    },
    $call$body$setupStorageDB_closure2(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        t1;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $.__currentNoteId = "";
              A._showHide(A.$("#newnote-gui", null)._elements, true);
              t1 = A.$("#newnote-header-text", null);
              t1.get$first(t1).innerText = "new";
              t1 = A.$("#newnote-type", null);
              B.InputElement_methods.set$value(type$.InputElement._as(t1.get$first(t1)), "note");
              t1 = A.$("#newnote-text", null);
              B.TextAreaElement_methods.set$value(type$.TextAreaElement._as(t1.get$first(t1)), "");
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
  ...
  A.setupStorageDB_closure1.prototype = {
    call$1(e) {
      return this.$call$body$setupStorageDB_closure1(type$.QueryEvent._as(e));
    },
    $call$body$setupStorageDB_closure1(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void);
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $.__currentNoteId = "";
              A._showHide(A.$("#newnote-gui", null)._elements, false);
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
  ...
  A.setupStorageDB_closure2.prototype = {
    call$1(e) {
      return this.$call$body$setupStorageDB_closure0(type$.QueryEvent._as(e));
    },
    $call$body$setupStorageDB_closure0(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, t1;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = $.__currentNoteId !== "" ? 3 : 4;
              break;
            case 3:
              // then
              t1 = window;
              t1.toString;
              if (!B.Window_methods.confirm$1(t1, "Delete note?")) {
                // goto return
                $async$goto = 1;
                break;
              }
              $async$goto = 5;
              return A._asyncAwait(A.$delete("notes", $.__currentNoteId), $async$call$1);
            case 5:
              // returning from await.
              A.$("#c-notes-note-" + $.__currentNoteInd, null).detach$0(0);
            case 4:
              // join
              $.__currentNoteId = "";
              A._showHide(A.$("#newnote-gui", null)._elements, false);
  ...
  A.setupStorageDB_closure3.prototype = {
    call$1(e) {
      return this.$call$body$setupStorageDB_closure(type$.QueryEvent._as(e));
    },
    $call$body$setupStorageDB_closure(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        ia, _id, _created, t2, t3, t4, t5, t1, ta;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = A.$("#newnote-text", null);
              ta = type$.TextAreaElement._as(t1.get$first(t1));
              t1 = A.$("#newnote-type", null);
              ia = type$.InputElement._as(t1.get$first(t1));
              t1 = $.__currentNoteId;
              $async$goto = t1 === "" ? 2 : 4;
              break;
            case 2:
            ...
            case 5:
              // then
              $async$goto = 7;
              return A._asyncAwait(A.add("notes", A.LinkedHashMap_LinkedHashMap$_literal(["content", t1, "type", ia.value], type$.String, type$.dynamic)), $async$call$1);
            case 7:
              // returning from await.
              _id = $async$result;
              _created = new A.DateTime(Date.now(), 0, false);
              t1 = A.monthShort(A.Primitives_getMonth(_created));
              t2 = B.JSInt_methods.toString$0(A.Primitives_getDay(_created));
              t3 = B.JSInt_methods.toString$0(A.Primitives_getYear(_created));
              t4 = ta.value;
              if (t4 == null)
                t4 = A._asString(t4);
              t5 = ia.value;
            ...
            case 8:
              // then
              $async$goto = 10;
              return A._asyncAwait(A.update("notes", t1, A.LinkedHashMap_LinkedHashMap$_literal(["content", t2, "type", ia.value], type$.String, type$.dynamic)), $async$call$1);
            case 10:
              // returning from await.
              t1 = J.$index$asx(A.$("#c-notes-note-" + $.__currentNoteInd, null).children$0(0)._elements, 0);
              t2 = ta.value;
              t1.innerText = t2 == null ? A._asString(t2) : t2;
              t1 = J.$index$asx(A.$("#c-notes-note-" + $.__currentNoteInd, null).children$0(0)._elements, 2);
              t2 = ia.value;
              t1.innerText = t2 == null ? A._asString(t2) : t2;
            case 9:
              // join
  ...
  A.setupStorageDB_closure4.prototype = {
    call$1(e) {
      type$.QueryEvent._as(e);
      type$.Location._as(window.location).reload();
    },
  ...
  A.setupStorageDB_closure5.prototype = {
    call$1(e) {
      type$.QueryEvent._as(e);
      A._showHide(A.$("#links-gui", null)._elements, true);
    },
    $signature: 2
  };
  A.setupSaltcornDB_closure.prototype = {
    call$1(e) {
      var t1, t2, _null = null;
      type$.QueryEvent._as(e);
      t1 = A.$("#tool-gui-header-text", _null);
      J.set$text$x(t1.get$first(t1), "new");
      $.__currentToolId = "";
      t1 = A.$("#tool-edit-name", _null);
      t2 = type$.InputElement;
      B.InputElement_methods.set$value(t2._as(t1.get$first(t1)), "");
      t1 = A.$("#tool-edit-href", _null);
      B.InputElement_methods.set$value(t2._as(t1.get$first(t1)), "");
      t1 = A.$("#tool-edit-desc", _null);
      B.InputElement_methods.set$value(t2._as(t1.get$first(t1)), "");
      t1 = A.$("#tool-edit-tags", _null);
      B.InputElement_methods.set$value(t2._as(t1.get$first(t1)), "");
      A._showHide(A.$("#tool-gui-edit", _null)._elements, true);
    },
    $signature: 2
  };
  A.setupSaltcornDB_closure0.prototype = {
    call$1(e) {
      type$.QueryEvent._as(e);
      A._showHide(A.$("#tool-gui-edit", null)._elements, false);
    },
    $signature: 2
  };
  A.setupSaltcornDB_closure1.prototype = {
    call$1(e) {
      return this.$call$body$setupSaltcornDB_closure(type$.QueryEvent._as(e));
    },
    $call$body$setupSaltcornDB_closure(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, href, desc, tags, t3, t1, t2, $name;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = A.$("#tool-edit-name", null);
              t2 = type$.InputElement;
              $name = t2._as(t1.get$first(t1)).value;
              if ($name == null)
                $name = A._asString($name);
              t1 = A.$("#tool-edit-href", null);
              href = t2._as(t1.get$first(t1)).value;
              if (href == null)
                href = A._asString(href);
              t1 = A.$("#tool-edit-desc", null);
              desc = t2._as(t1.get$first(t1)).value;
              if (desc == null)
                desc = A._asString(desc);
              t1 = A.$("#tool-edit-tags", null);
              tags = t2._as(t1.get$first(t1)).value;
              if (tags == null)
                tags = A._asString(tags);
              if ($name === "" || href === "") {
                // goto return
                $async$goto = 1;
                break;
              ...
              t3 = type$.dynamic;
              if (t1 === "")
                A.add("tools", A.LinkedHashMap_LinkedHashMap$_literal(["name", $name, "href", href, "description", desc, "tags", tags], t2, t3));
              else
                A.update("tools", t1, A.LinkedHashMap_LinkedHashMap$_literal(["name", $name, "href", href, "description", desc, "tags", tags], t2, t3));
              A._showHide(A.$("#tool-gui-edit", null)._elements, false);
            case 1:
              // return
              return A._asyncReturn($async$returnValue, $async$completer);
  ...
  A.setupSaltcornDB_closure2.prototype = {
    call$1(e) {
      return J.remove$0$ax(type$.Element._as(e));
    },
    $signature: 5
  };
  A.setupSaltcornDB_closure3.prototype = {
    call$1(e) {
      var t1, t2, text, ttag, _null = null;
      type$.QueryEvent._as(e);
      t1 = A.$("#tool-searchbar", _null);
      t2 = type$.InputElement;
      text = t2._as(t1.get$first(t1)).value;
      if (text == null)
        text = A._asString(text);
      t1 = A.$("#tool-tag-searchbar", _null);
      ttag = t2._as(t1.get$first(t1)).value;
      if (ttag == null)
        ttag = A._asString(ttag);
      t1 = this.field;
      t2 = J.getInterceptor$asx(t1);
      t1 = (B.JSString_methods.contains$1(A._asString(t2.$index(t1, "name")).toLowerCase(), text.toLowerCase()) || B.JSString_methods.contains$1(A._asString(t2.$index(t1, "description")).toLowerCase(), text.toLowerCase())) && B.JSString_methods.contains$1(("," + A._asString(t2.$index(t1, "tags")) + ",").toLowerCase(), ttag.toLowerCase());
      t2 = "#" + this.id;
      if (t1)
        A._showHide(A.$(t2, _null)._elements, true);
      else
        A._showHide(A.$(t2, _null)._elements, false);
    },
    $signature: 76
  };
  A.setupSaltcornDB_closure4.prototype = {
    call$1(e) {
      var t1, t2, t3, t4, _null = null;
      type$.QueryEvent._as(e);
      t1 = A.$("#tool-gui-header-text", _null);
      J.set$text$x(t1.get$first(t1), "edit");
      t1 = this.field;
      t2 = J.getInterceptor$asx(t1);
      $.__currentToolId = A.S(t2.$index(t1, "objectId"));
      t3 = A.$("#tool-edit-name", _null);
      t4 = type$.InputElement;
      B.InputElement_methods.set$value(t4._as(t3.get$first(t3)), A._asStringQ(t2.$index(t1, "name")));
      t3 = A.$("#tool-edit-href", _null);
      B.InputElement_methods.set$value(t4._as(t3.get$first(t3)), A._asStringQ(t2.$index(t1, "href")));
      t3 = A.$("#tool-edit-desc", _null);
      B.InputElement_methods.set$value(t4._as(t3.get$first(t3)), A._asStringQ(t2.$index(t1, "description")));
      t3 = A.$("#tool-edit-tags", _null);
      B.InputElement_methods.set$value(t4._as(t3.get$first(t3)), A._asStringQ(t2.$index(t1, "tags")));
      A._showHide(A.$("#tool-gui-edit", _null)._elements, true);
    },
    $signature: 2
  };
  A.setupSaltcornDB_closure5.prototype = {
    call$1(e) {
      var t1, t2, t3;
      type$.QueryEvent._as(e);
      t1 = window;
      ...
      if (!B.Window_methods.confirm$1(t1, "Do you want to delete tool '" + A.S(t3.$index(t2, "name")) + "'?"))
        return;
      A.$delete("tools", A.S(t3.$index(t2, "objectId")));
      t1 = A.$("#" + this.id, null);
      J.remove$0$ax(t1.get$first(t1));
    },
    $signature: 2
  };
  A.addBackendlessNotes_closure.prototype = {
    call$1(obj) {
      var t1 = J.getInterceptor$asx(obj),
        _created = A.DateTime$fromMillisecondsSinceEpoch(A._asInt(t1.$index(obj, "created"))),
        t2 = A.monthShort(A.Primitives_getMonth(_created)),
        t3 = B.JSInt_methods.toString$0(A.Primitives_getDay(_created)),
        t4 = B.JSInt_methods.toString$0(A.Primitives_getYear(_created));
      A.addNote(A._asString(t1.$index(obj, "content")), t2 + " " + t3 + ", " + t4, A._asString(t1.$index(obj, "type")), A._asString(t1.$index(obj, "objectId")));
    },
    $signature: 7
  };
  A.addBackendlessLinks_closure.prototype = {
    call$1(obj) {
      var t1 = J.getInterceptor$asx(obj);
      A.addLinkTo(A._asString(t1.$index(obj, "name")), A._asString(t1.$index(obj, "href")), A._asString(t1.$index(obj, "category")), A._asInt(t1.$index(obj, "priority")), A._asString(t1.$index(obj, "objectId")));
    },
    $signature: 7
  };
  A.addLinkTo_closure.prototype = {
    call$1(e) {
      return this.$call$body$addLinkTo_closure0(type$.QueryEvent._as(e));
    },
    $call$body$addLinkTo_closure0(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, t4, t5, t6, t7, t8, t9, t1, t2, t3;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            ...
            case 2:
              ...
              t1 = "#links-name-" + t3;
              t4 = A.$(t1, null);
              t4 = t2._as(t4.get$first(t4)).value;
              t5 = "#links-href-" + t3;
              t6 = A.$(t5, null);
              t6 = t2._as(t6.get$first(t6)).value;
              t7 = "#links-cate-" + t3;
              t8 = A.$(t7, null);
              t8 = t2._as(t8.get$first(t8)).value;
              t3 = "#links-prio-" + t3;
              t9 = A.$(t3, null);
              t9 = t2._as(t9.get$first(t9)).value;
              $async$goto = 5;
              return A._asyncAwait(A.add("links", A.LinkedHashMap_LinkedHashMap$_literal(["name", t4, "href", t6, "category", t8, "priority", A.int_parse(t9 == null ? A._asString(t9) : t9, null)], type$.String, type$.dynamic)), $async$call$1);
            case 5:
              // returning from await.
              t1 = A.$(t1, null);
              B.InputElement_methods.set$value(t2._as(t1.get$first(t1)), "");
              t5 = A.$(t5, null);
              B.InputElement_methods.set$value(t2._as(t5.get$first(t5)), "");
              t7 = A.$(t7, null);
              B.InputElement_methods.set$value(t2._as(t7.get$first(t7)), "");
              t3 = A.$(t3, null);
              B.InputElement_methods.set$value(t2._as(t3.get$first(t3)), "0");
              // goto join
              $async$goto = 3;
              break;
            case 4:
              // else
              t4 = A.$("#links-name-" + t3, null);
              t4 = t2._as(t4.get$first(t4)).value;
              t5 = A.$("#links-href-" + t3, null);
              t5 = t2._as(t5.get$first(t5)).value;
              t6 = A.$("#links-cate-" + t3, null);
              t6 = t2._as(t6.get$first(t6)).value;
              t3 = A.$("#links-prio-" + t3, null);
              t3 = t2._as(t3.get$first(t3)).value;
              $async$goto = 6;
              return A._asyncAwait(A.update("links", t1, A.LinkedHashMap_LinkedHashMap$_literal(["name", t4, "href", t5, "category", t6, "priority", A.int_parse(t3 == null ? A._asString(t3) : t3, null)], type$.String, type$.dynamic)), $async$call$1);
            case 6:
              // returning from await.
            case 3:
              // join
  ...
  A.addLinkTo_closure0.prototype = {
    call$1(e) {
      return this.$call$body$addLinkTo_closure(type$.QueryEvent._as(e));
    },
    $call$body$addLinkTo_closure(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
          ...
          switch ($async$goto) {
            case 0:
              ...
              if (t1 !== "") {
                t2 = window;
                t2.toString;
                t2 = B.Window_methods.confirm$1(t2, "delete link?");
              } else
                t2 = false;
              $async$goto = t2 ? 2 : 3;
              break;
            case 2:
              // then
              $async$goto = 4;
              return A._asyncAwait(A.$delete("links", t1), $async$call$1);
            case 4:
              // returning from await.
              A.$("#links-container-" + $async$self.linkID, null).detach$0(0);
            case 3:
              // join
              // implicit return
              return A._asyncReturn(null, $async$completer);
  ...
  A.addBackendlessTodos_closure.prototype = {
    call$1(obj) {
      var t1 = J.getInterceptor$asx(obj);
      A.addTodo(A._asString(t1.$index(obj, "name")), A._asString(t1.$index(obj, "status")), A._asString(t1.$index(obj, "objectId")));
    },
    $signature: 7
  };
  A.addTodo_closure.prototype = {
    call$1(e) {
      var t1, t2, t3, t4, _this = this, _s4_ = "todo", _null = null,
        _s12_ = "c-task-doing",
        _s11_ = "c-task-done";
      type$.QueryEvent._as(e);
      if (e.get$button(0) === 0) {
        ...
        t4 = type$.dynamic;
        if (t1.status === "done") {
          A.update(_s4_, t2, A.LinkedHashMap_LinkedHashMap$_literal(["status", "todo"], t3, t4));
          t1.status = _s4_;
        } else {
          A.update(_s4_, t2, A.LinkedHashMap_LinkedHashMap$_literal(["status", "done"], t3, t4));
          t1.status = "done";
        }
      }
      if (e.get$button(0) === 1) {
        A.update(_s4_, _this.oid, A.LinkedHashMap_LinkedHashMap$_literal(["status", "doing"], type$.String, type$.dynamic));
        _this._box_0.status = "doing";
      }
      if (e.get$button(0) === 2) {
        t1 = window;
        t1.toString;
        if (!B.Window_methods.confirm$1(t1, "Delete task?"))
          return;
        A.$delete(_s4_, _this.oid);
        A.$("#c-task-" + _this.todoID, _null).detach$0(0);
      }
      t1 = _this._box_0;
      t2 = t1.status;
      if (t2 === "doing") {
        t1.icon = "check_box_line";
        t2 = _this.todoID;
        t3 = "#c-task-" + t2;
        A.$(t3, _null).addClass$1(_s12_);
        A.$(t3, _null).removeClass$1(_s11_);
      } else {
        t3 = _this.todoID;
        t4 = "" + t3;
        if (t2 === "done") {
          t1.icon = "check_box_complete";
          t2 = "#c-task-" + t4;
          A.$(t2, _null).removeClass$1(_s12_);
          A.$(t2, _null).addClass$1(_s11_);
        } else {
          t1.icon = "check_box_outline";
          t2 = "#c-task-" + t4;
          A.$(t2, _null).removeClass$1(_s12_);
          A.$(t2, _null).removeClass$1(_s11_);
        }
        t2 = t3;
      }
  ...
  A.addNote_closure.prototype = {
    call$1(e) {
      var t1, t2, t3, _null = null;
      type$.QueryEvent._as(e);
      $.__currentNoteId = this.oid;
      t1 = this.noteID;
      $.__currentNoteInd = t1;
      A._showHide(A.$("#newnote-gui", _null)._elements, true);
      t2 = A.$("#newnote-header-text", _null);
      t2.get$first(t2).innerText = "edit";
      t2 = A.$("#newnote-type", _null);
      t2 = type$.InputElement._as(t2.get$first(t2));
      t1 = "#c-notes-note-" + t1;
      t3 = J.$index$asx(A.$(t1, _null).children$0(0)._elements, 2).innerText;
      t3.toString;
      B.InputElement_methods.set$value(t2, t3);
      t3 = A.$("#newnote-text", _null);
      t3 = type$.TextAreaElement._as(t3.get$first(t3));
      t1 = J.$index$asx(A.$(t1, _null).children$0(0)._elements, 0).innerText;
      t1.toString;
      B.TextAreaElement_methods.set$value(t3, t1);
    },
    $signature: 2
  };
  A.get_closure.prototype = {
    call$2(a, b) {
      var t2, priority, i, t3, prop, w, t4,
        t1 = this.q.query.$index(0, "sortBy"),
        s = (t1 == null ? A._asString(t1) : t1).split(",");
      for (t1 = J.getInterceptor$asx(b), t2 = J.getInterceptor$asx(a), priority = 0, i = 0; t3 = s.length, i < t3; ++i) {
        prop = s[i];
        w = (t3 - i) * 5;
        if (typeof t2.$index(a, prop) == "string") {
          t3 = A._asString(t2.$index(a, prop));
          t4 = A._asString(t1.$index(b, prop));
          if (t3 === t4)
            t3 = 0;
          else
            t3 = t3 < t4 ? -1 : 1;
          ...
          t3 = A._asInt(J.$sub$n(t2.$index(a, prop), t1.$index(b, prop)));
          if (t3 > 0)
            t3 = 1;
          else if (t3 < 0)
            t3 = -1;
      ...
      return B.JSInt_methods.get$sign(priority);
    },
    $signature: 16
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _instance(A._Completer.prototype, "get$completeError", 0, 1, function() {
      return [null];
    }, ["call$2", "call$1"], ["completeError$2", "completeError$1"], 75, 0, 0);
    ...
    _static_2(A, "collection_ListBase__compareAny$closure", "ListBase__compareAny", 16);
    _static_1(A, "convert___defaultToEncodable$closure", "_defaultToEncodable", 6);
    var _;
    _instance_1_i(_ = A._ByteCallbackSink.prototype, "get$add", "add$1", 58);
    _instance_0_i(_, "get$close", "close$0", 0);
    _static_1(A, "core__identityHashCode$closure", "identityHashCode", 32);
    _static_2(A, "core__identical$closure", "identical", 31);
    _static_1(A, "core_Uri_decodeComponent$closure", "Uri_decodeComponent", 9);
    _static(A, "html__Html5NodeValidator__standardAttributeValidator$closure", 4, null, ["call$4"], ["_Html5NodeValidator__standardAttributeValidator"], 21, 0);
    _static(A, "html__Html5NodeValidator__uriAttributeValidator$closure", 4, null, ["call$4"], ["_Html5NodeValidator__uriAttributeValidator"], 21, 0);
    _instance_0_i(A.CacheStorage.prototype, "get$keys", "keys$0", 80);
    _instance_0_i(A.PaymentInstruments.prototype, "get$keys", "keys$0", 84);
    _static_1(A, "js___convertToJS$closure", "_convertToJS", 82);
    _static_1(A, "js___convertToDart$closure", "_convertToDart", 83);
    _static_2(A, "dquery___appendFunc$closure", "_appendFunc", 27);
    _static_2(A, "dquery___prependFunc$closure", "_prependFunc", 27);
    _static(A, "dquery___createMap$closure", 0, null, ["call$2$0", "call$0"], ["_createMap", function() {
      var t1 = type$.dynamic;
      return A._createMap(t1, t1);
    }], 85, 0);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Instantiation, A.Closure2Args, A.TearOffClosure, A.JsLinkedHashMap_values_closure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_contains_closure0, A.Stream_contains__closure0, A.Stream_forEach_closure0, A.Stream_forEach__closure0, A.Stream_length_closure, A.Stream_isEmpty_closure0, A.Stream_first_closure0, A._RootZone_bindUnaryCallbackGuarded_closure, A._LinkedCustomHashMap_closure, A.MapBase_entries_closure, A._Uri__makePath_closure, A._createTables_setChars, A._createTables_setRange, A.Element_Element$html_closure, A.NodeValidatorBuilder_allowsElement_closure, A.NodeValidatorBuilder_allowsAttribute_closure, A._SimpleNodeValidator_closure, A._SimpleNodeValidator_closure0, A._TemplatingNodeValidator_closure, A.CssClassSetImpl_add_closure, A.FilteredElementList__iterable_closure, A.FilteredElementList__iterable_closure0, A.FilteredElementList_removeRange_closure, A._convertToJS_closure, A._convertToJS_closure0, A._wrapToDart_closure, A._wrapToDart_closure0, A._wrapToDart_closure1, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.CanonicalizedMap_keys_closure, A._Query__on_closure, A._ElementQuery_clone_closure, A._ElementQuery_detach_closure, A._ElementQuery_text_closure, A._EventUtil_add__closure, A._EventUtil_remove_closure, A._initMouseenterleave_closure, A._initNotSupportFocusinBubbles_closure, A._initNotSupportFocusinBubbles_closure0, A._initNotSupportFocusinBubbles_closure1, A.QueryEvent_relatedTarget_closure, A.QueryEvent_button_closure, A.QueryEvent_defaultPrevented_closure, A._appendFunc_closure, A._prependFunc_closure, A.get_closure0, A.post_closure, A.put_closure, A.delete_closure, A.BaseRequest_closure0, A.BrowserClient_send_closure, A.BrowserClient_send_closure0, A.ByteStream_toBytes_closure, A.MediaType_toString__closure, A.expectQuotedString_closure, A.Context_joinAll_closure, A.Context_split_closure, A._validateArgList_closure, A.Highlighter$__closure, A.Highlighter$___closure, A.Highlighter$__closure0, A.Highlighter__collateLines_closure, A.Highlighter__collateLines_closure1, A.Highlighter__collateLines__closure, A.Highlighter_highlight_closure, A._EventStreamSubscription_closure, A._EventStreamSubscription_onData_closure, A.MapAttr_attr__closure, A.main_closure, A.main_closure0, A.main_closure1, A.main_closure2, A.setupBackendlessDB_closure, A.setupBackendlessDB_closure0, A.setupStorageDB_closure, A.setupStorageDB_closure0, A.setupStorageDB_closure1, A.setupStorageDB_closure2, A.setupStorageDB_closure3, A.setupStorageDB_closure4, A.setupStorageDB_closure5, A.setupSaltcornDB_closure, A.setupSaltcornDB_closure0, A.setupSaltcornDB_closure1, A.setupSaltcornDB_closure2, A.setupSaltcornDB_closure3, A.setupSaltcornDB_closure4, A.setupSaltcornDB_closure5, A.addBackendlessNotes_closure, A.addBackendlessLinks_closure, A.addLinkTo_closure, A.addLinkTo_closure0, A.addBackendlessTodos_closure, A.addTodo_closure, A.addNote_closure]);
    _inheritMany(A.Closure0Args, [A.nullFuture_closure, A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._Future__addListener_closure, A._Future__prependListeners_closure, A._Future__chainForeignFuture_closure1, A._Future__chainCoreFutureAsync_closure, A._Future__asyncCompleteWithValue_closure, A._Future__asyncCompleteError_closure, A._Future__propagateToListeners_handleWhenCompleteCallback, A._Future__propagateToListeners_handleValueCallback, A._Future__propagateToListeners_handleError, A.Stream_contains_closure, A.Stream_contains__closure, A.Stream_forEach_closure, A.Stream_forEach__closure, A.Stream_length_closure0, A.Stream_isEmpty_closure, A.Stream_first_closure, A._StreamController__subscribe_closure, A._StreamController__recordCancel_complete, A._BufferingStreamSubscription__sendDone_sendDone, A._PendingEvents_schedule_closure, A._cancelAndError_closure, A._cancelAndValue_closure, A._rootHandleError_closure, A._RootZone_bindCallbackGuarded_closure, A._Utf8Decoder__decoder_closure, A._Utf8Decoder__decoderNonfatal_closure, A.CanonicalizedMap_putIfAbsent_closure, A._EventUtil_add_closure, A._EventUtil_add_closure0, A._EventUtil_remove_closure_matchNamespaces, A._EventUtil_handlers_closure, A.MediaType_MediaType$parse_closure, A.Highlighter_closure, A.Highlighter__writeFileStart_closure, A.Highlighter__writeMultilineHighlights_closure, A.Highlighter__writeMultilineHighlights_closure0, A.Highlighter__writeMultilineHighlights_closure1, A.Highlighter__writeMultilineHighlights_closure2, A.Highlighter__writeMultilineHighlights__closure, A.Highlighter__writeMultilineHighlights__closure0, A.Highlighter__writeHighlightedText_closure, A.Highlighter__writeIndicator_closure, A.Highlighter__writeIndicator_closure0, A.Highlighter__writeIndicator_closure1, A.Highlighter__writeSidebar_closure, A._Highlight_closure]);
    _inheritMany(A.Iterable, [A.EfficientLengthIterable, A.MappedIterable, A.WhereIterable, A.ExpandIterable, A.TakeIterable, A.SkipIterable, A.WhereTypeIterable, A._KeysOrValues, A._AllMatchesIterable, A._StringAllMatchesIterable]);
    ...
    _inheritMany(A.Closure2Args, [A.Primitives_functionNoSuchMethod_closure, A.JsLinkedHashMap_addAll_closure, A.initHooks_closure0, A._awaitOnObject_closure0, A._wrapJsFunctionForAsync_closure, A._Future__chainForeignFuture_closure0, A._cancelAndErrorClosure_closure, A.LinkedHashMap_LinkedHashMap$from_closure, A.MapBase_addAll_closure, A.MapBase_mapToString_closure, A._JsonMap_addAll_closure, A._JsonStringifier_writeMap_closure, A.NoSuchMethodError_toString_closure, A._Uri__makeQueryFromParameters_closure, A.Uri__parseIPv4Address_error, A.Uri_parseIPv6Address_error, A.Uri_parseIPv6Address_parseHex, A._Uri__makeQueryFromParametersDefault_writeParameter, A._Uri__makeQueryFromParametersDefault_closure, A._createTables_build, A.MidiInputMap_keys_closure, A.MidiOutputMap_keys_closure, A.RtcStatsReport_keys_closure, A.Storage_addAll_closure, A.Storage_keys_closure, A._AttributeMap_addAll_closure, A._ValidatingTreeSanitizer_sanitizeTree_walk, A.AudioParamMap_keys_closure, A.CanonicalizedMap_addAll_closure, A.CanonicalizedMap_forEach_closure, A._SPECIAL_HANDLINGS_closure, A._SPECIAL_HANDLINGS_closure0, A._SPECIAL_HANDLINGS_closure1, A.BaseRequest_closure, A.MediaType_toString_closure, A.Highlighter__collateLines_closure0, A.MapAttr_attr_closure, A.get_closure]);
    ...
    _inheritMany(A.EventTarget, [A.Node, A.FileWriter, A.FontFaceSet, A.MessagePort, A.SourceBuffer, A._SourceBufferList_EventTarget_ListMixin, A.TextTrack, A.TextTrackCue, A._TextTrackList_EventTarget_ListMixin, A.VideoTrackList, A.Window, A.WorkerGlobalScope, A.AudioTrackList, A.BaseAudioContext]);
    _inheritMany(A.Node, [A.Element, A.CharacterData, A.Document, A._Attr]);
    _inheritMany(A.Element, [A.HtmlElement, A.SvgElement]);
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.BaseElement, A.BodyElement, A.FormElement, A.InputElement, A.OListElement, A.SelectElement, A.TableElement, A.TableRowElement, A.TableSectionElement, A.TemplateElement, A.TextAreaElement]);
    ...
    _inheritMany(A.UIEvent, [A.FocusEvent, A.MouseEvent]);
    ...
    _inheritMany(A._Query, [A.__DocumentQuery__Query_ListMixin, A.__ElementQuery__Query_ListMixin]);
    _inherit(A._DocumentQuery, A.__DocumentQuery__Query_ListMixin);
    _inherit(A._ElementQuery, A.__ElementQuery__Query_ListMixin);
  ...
  var string$ = {
    ...
    You_ca: "You can only attach EventListeners to your own window."
  };
  var type$ = (function rtii() {
    ...
    return {
      ...
      CharacterData: findType("CharacterData"),
      ...
      Expando_Map_String_dynamic: findType("Expando<Map<String,@>>"),
      File: findType("File"),
      ...
      JSArray_EventTarget: findType("JSArray<EventTarget>"),
      ...
      JSArray__HandleObject: findType("JSArray<_HandleObject>"),
      JSArray__HandlerQueueEntry: findType("JSArray<_HandlerQueueEntry>"),
      ...
      _HandleObject: findType("_HandleObject"),
      _HandleObjectContext: findType("_HandleObjectContext"),
      ...
      nullable__HandleObject: findType("_HandleObject?"),
      nullable__Highlight: findType("_Highlight?"),
      nullable__LinkedHashSetCell: findType("_LinkedHashSetCell?"),
      nullable__Query_EventTarget: findType("_Query<EventTarget>?"),
      ...
      nullable_void_Function_QueryEvent: findType("~(QueryEvent)?"),
      num: findType("num"),
      void: findType("~"),
      ...
      void_Function_QueryEvent: findType("~(QueryEvent)"),
  ...
  (function constants() {
    ...
    B.CONSTANT = new A.Instantiation2(A.dquery___createMap$closure(), A.findType("Instantiation2<@,@>"));
...
;
  ...
  (function staticFields() {
    ...
    $._elemDisplay = function() {
      var t1 = type$.String;
      return A.LinkedHashMap_LinkedHashMap$_literal(["body", "block"], t1, t1);
    }();
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "_dataPriv", "$get$_dataPriv", () => A._Storage$("dquery-data-priv"));
    _lazyFinal($, "_rootDQuery", "$get$_rootDQuery", () => A._DocumentQuery$(null));
    _lazyFinal($, "_EventUtil__SPACES", "$get$_EventUtil__SPACES", () => A.RegExp_RegExp("\\s+"));
    _lazyFinal($, "_HandleObjectContext_EMPTY", "$get$_HandleObjectContext_EMPTY", () => A._HandleObjectContext$());
    _lazyFinal($, "_SpecialEventHandler_EMPTY", "$get$_SpecialEventHandler_EMPTY", () => {
      var _null = null;
      return A._SpecialEventHandler$(_null, _null, _null, false, _null, _null, _null);
    });
    _lazyFinal($, "_SPECIAL_HANDLINGS", "$get$_SPECIAL_HANDLINGS", () => {
      var t6, t7, t8, _null = null,
        _s8_ = "focusout",
        t1 = A._SpecialEventHandler$(_null, _null, _null, true, _null, _null, _null),
        t2 = A._SpecialEventHandler$(_null, _null, _null, false, _null, _null, new A._SPECIAL_HANDLINGS_closure()),
        t3 = A._SpecialEventHandler$(_null, "focusin", _null, false, _null, _null, new A._SPECIAL_HANDLINGS_closure0()),
        t4 = A._SpecialEventHandler$(_null, _s8_, _null, false, _null, _null, new A._SPECIAL_HANDLINGS_closure1()),
        t5 = $._focusinHandling;
      if (t5 == null)
        t5 = $._focusinHandling = A._initNotSupportFocusinBubbles("focus", "focusin");
      t6 = $._focusoutHandling;
      if (t6 == null)
        t6 = $._focusoutHandling = A._initNotSupportFocusinBubbles("blur", _s8_);
      t7 = $._mouseenterHandling;
      if (t7 == null)
        t7 = $._mouseenterHandling = A._initMouseenterleave("mouseenter", "mouseover");
      t8 = $._mouseleaveHandling;
      return A.LinkedHashMap_LinkedHashMap$_literal(["load", t1, "click", t2, "focus", t3, "blur", t4, "focusin", t5, "focusout", t6, "mouseenter", t7, "mouseleave", t8 == null ? $._mouseleaveHandling = A._initMouseenterleave("mouseleave", "mouseout") : t8], type$.String, A.findType("_SpecialEventHandler"));
    });
    _lazyFinal($, "BaseRequest__tokenRE", "$get$BaseRequest__tokenRE", () => A.RegExp_RegExp("^[\\w!#%&'*+\\-.^`|~]+$"));
    _lazyFinal($, "_digitRegex", "$get$_digitRegex", () => A.RegExp_RegExp("^\\d+$"));
    ...
    _lazy($, "__linksPreset", "$get$__linksPreset", () => {
      var _s4_ = "work", _s6_ = "social", _s4_0 = "tool", _s4_1 = "docs";
      return "[" + B.JSArray_methods.join$1(A._setArrayType([A.__link("github", "https://github.com/al1-ce", _s4_, 10), A.__link("gitlab", "https://gitlab.com", _s4_, 9), A.__link("atheos", "https://al1-ce.dev", _s4_, 8), A.__link("regex", "https://regex101.com", _s4_, 7), A.__link("localhost", "http://127.0.0.1:8080", _s4_, 6), A.__link("backendless", "https://eu-develop.backendless.com/app/", _s4_, 5), A.__link("youtube", "https://youtube.com", _s6_, 9), A.__link("twitter", "https://twitter.com", _s6_, 8), A.__link("telegram", "https://web.telegram.org/a/", _s6_, 7), A.__link("discord", "https://discord.com/app", _s6_, 6), A.__link("twitch", "https://twitch.tv", _s6_, 5), A.__link("mail", "https://mail.com", _s6_, 4), A.__link("neocities", "https://neocities.org", _s6_, 3), A.__link("dev.to", "https://dev.to", _s6_, 2), A.__link("rund", "https://run.dlang.io", _s4_0, 9), A.__link("blackboard", "https://excalidraw.com", _s4_0, 8), A.__link("stackedit", "https://stackedit.io/app", _s4_0, 7), A.__link("material", "https://fonts.google.com/icons", _s4_0, 6), A.__link("csshex", "https://isotropic.co/tool/hex-color-to-css-filter/", _s4_0, 5), A.__link("jscanvas", "https://natto.dev", _s4_0, 4), A.__link("dub", "https://code.dlang.org", _s4_1, 9), A.__link("icons", "https://simpleicons.org", _s4_1, 8), A.__link("badgen", "https://badgen.net", _s4_1, 7), A.__link("badge", "https://shields.io", _s4_1, 6), A.__link("gruvbox", "https://camo.githubusercontent.com/410b3ab80570bcd5b470a08d84f93caa5b4962ccd994ebceeb3d1f78364c2120/687474703a2f2f692e696d6775722e636f6d2f776136363678672e706e67", _s4_1, 5), A.__link("charm", "https://charm.sh", _s4_1, 4)], type$.JSArray_String), ",") + "]";
    });
    _lazy($, "__storageCache", "$get$__storageCache", () => new A.JsLinkedHashMap(A.findType("JsLinkedHashMap<String,Map<String,@>>")));
  })();
