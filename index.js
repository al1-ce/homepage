...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    _showHide(elements, show) {
      ...
      for (t2 = J.getInterceptor$ax(elements), t3 = t2.get$iterator(elements); t3.moveNext$0();) {
        ...
        oldDisplay = space == null ? null : space.$index(0, _s10_);
        t6 = oldDisplay == null;
        if (!t6)
        ...
        if (show) {
          ...
          if (t6 === "" && A._isHidden(t4)) {
            ...
            t5.getSpace$1(t4).$indexSet(0, _s10_, display);
          }
        } else if (!values.containsKey$1(t4)) {
          ...
          if (t8.length !== 0 && t8 !== "none" || !hidden) {
            ...
            t5.getSpace$1(t4).$indexSet(0, _s10_, t6);
          }
        }
      }
    ...
    _EventUtil_add(eventTarget, types, handler, selector) {
      var space, events, eventHandles, t1, t2, t3, t4, t5, t6, _i, _box_0, type, namespaces, t7, t8, type0, eventHandle, handleObjCtx;
      if (type$.CharacterData._is(eventTarget))
        return;
      space = $.$get$_dataPriv().getSpace$1(eventTarget);
      events = space.putIfAbsent$2("events", B.CONSTANT0);
      eventHandles = space.putIfAbsent$2("handles", B.CONSTANT0);
      t1 = B.JSString_methods.split$1(types, $.$get$_EventUtil__SPACES());
      t2 = t1.length;
      t3 = type$.dynamic_Function_Event;
      t4 = type$._HandleObjectContext;
      ...
      for (; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
        ...
        namespaces = A._setArrayType([], t5);
        if (J.indexOf$1$asx(type, ".") >= 0) {
          namespaces = A._setArrayType(type.split("."), t5);
          ...
          if (t7 - 0 <= 32)
            A.Sort__insertionSort(namespaces, 0, t7, J._interceptors_JSArray__compareAny$closure(), t6);
          else
            A.Sort__dualPivotQuicksort(namespaces, 0, t7, J._interceptors_JSArray__compareAny$closure(), t6);
        }
        if (type.length === 0)
          continue;
        t7 = $.$get$_SPECIAL_HANDLINGS();
        t8 = t7.$index(0, type);
        if (t8 == null)
          t8 = $.$get$_SpecialEventHandler_EMPTY();
        _box_0.special = t8;
        type0 = t8.bindType;
        if (type0 == null)
          type0 = type;
        _box_0.type = type0;
        t7 = t7.$index(0, type0);
        _box_0.special = t7 == null ? $.$get$_SpecialEventHandler_EMPTY() : t7;
        t7 = B.JSArray_methods.join$1(namespaces, ".");
        eventHandle = t3._as(eventHandles.putIfAbsent$2(type0, new A._EventUtil_add_closure(_box_0, eventTarget)));
        handleObjCtx = t4._as(events.putIfAbsent$2(_box_0.type, new A._EventUtil_add_closure0(_box_0, eventTarget, eventHandle)));
        B.JSArray_methods.add$1(handleObjCtx.handlers, new A._HandleObject(selector, type, t7, false, handler));
      }
    },
    _EventUtil_remove(elem, types, handler, selector, mappedTypes) {
      ...
      for (; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
        ...
        if (type.length === 0) {
          ...
          for (t7 = J.toList$0$ax(events.get$keys()), t8 = t7.length, _i0 = 0; _i0 < t7.length; t7.length === t8 || (0, A.throwConcurrentModificationError)(t7), ++_i0)
        ...
        if (delegates.length === 0 && handlers.length === 0) {
          ...
          if (t7 == null || !A.boolConversionCheck(t7.call$1(elem))) {
            ...
            eventHandles = space == null ? null : space.$index(0, "handles");
    ...
    _EventUtil_triggerEvent($event) {
      ...
      for (t2 = eventPath.length, t3 = type$.Map_dynamic_dynamic, t1 = t1.bindType, t4 = type$.dynamic, t5 = $event.originalEvent, first = true, _i = 0; _i < eventPath.length; eventPath.length === t2 || (0, A.throwConcurrentModificationError)(eventPath), ++_i, first = false) {
        ...
        t6 = space == null ? _null : space.$index(0, "events");
    ...
    _EventUtil_dispatch(elem, dqevent, type) {
      ...
      t1 = A._EventUtil__getEvents(elem).$index(0, type);
      if (t1 == null)
        ...
        if (t1._is(cur)) {
          ...
          while (t5 == null ? elem != null : t5 !== elem) {
            ...
            for (t5 = delegates.length, _i = 0; _i < delegates.length; delegates.length === t5 || (0, A.throwConcurrentModificationError)(delegates), ++_i) {
              ...
              if (A.boolConversionCheck(matches.putIfAbsent$2(" ", new A._EventUtil_handlers_closure(_box_0, handleObj, " ", elem))))
    ...
    _cleanData(element) {
      ...
      for (t1 = J.get$children$x(element), t1 = t1.toList$0(t1), t2 = t1.length, t3 = type$.Object, t4 = type$.Map_dynamic_dynamic, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
        ...
        if (!(space != null && !space.get$isEmpty(space)))
          continue;
        space = t5.getSpace$1(c);
        if (space.containsKey$1("events"))
          for (t5 = J.get$iterator$ax(t4._as(space.$index(0, "events")).get$keys()); t5.moveNext$0();)
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              if (j.containsKey$1("user-token")) {
                t1 = A._asString(j.$index(0, "user-token"));
                $.BackendlessDB_userToken = t1;
                if (stayLoggedFor > 0) {
                  t2 = B.JSInt_methods.toString$0(stayLoggedFor * 24 * 60 * 60);
                  t3 = document;
                  t3.toString;
                  B.HtmlDocument_methods.set$cookie(t3, "userToken=" + t1 + ";" + ("max-age=" + t2) + ";path=/");
                }
              }
              $async$returnValue = j;
              // goto return
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2 = type$.String;
              $async$goto = 3;
              return A._asyncAwait(A.get(A._Uri__makeHttpUri("https", t1, "api/users/logout", null), A.LinkedHashMap_LinkedHashMap$_literal(["user-token", $.BackendlessDB_userToken], t2, t2)), $async$UserService_logout);
            case 3:
              // returning from await.
              // goto return
              $async$goto = 1;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 3;
              return A._asyncAwait(A.get(A._Uri__makeHttpUri("https", t2, "api/users/isvalidusertoken/" + t1, null), null), $async$UserService_isValidLogin);
            case 3:
              // returning from await.
              ...
              if (!isLoggedIn) {
                t1 = document;
                t1.toString;
                B.HtmlDocument_methods.set$cookie(t1, "userToken=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;");
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp2 = B.C_Utf8Codec;
              $async$goto = 3;
              return A._asyncAwait(A.get(A._Uri__makeHttpUri("https", t1, "api/data/" + table, query.query), headers), $async$Data_find);
            case 3:
              // returning from await.
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp2 = B.C_Utf8Codec;
              $async$goto = 3;
              return A._asyncAwait(A.$delete(A._Uri__makeHttpUri("https", t1, "api/data/" + table + "/" + objectID, null), headers), $async$Data_delete);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1.jsonDecode($async$temp2.decode$1(0, $async$result.bodyBytes));
              // goto return
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 2:
              ...
              A.$("#newnote-delete", null)._on$4("click", t1._as(new A.main_closure5()), null, false);
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = J;
              $async$goto = 2;
              return A._asyncAwait(A.Data_find("notes", new A.DataQuery(t1)), $async$addBackendlessNotes);
            case 2:
              // returning from await.
              $async$temp1.forEach$1$ax($async$result.$index(0, "jsarr"), new A.addBackendlessNotes_closure());
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp2 = J;
              $async$goto = 2;
              return A._asyncAwait(A.Data_find("links", new A.DataQuery(t1)), $async$addBackendlessLinks);
            case 2:
              // returning from await.
              $async$temp1.forEach$1$ax($async$temp2.get$reversed$ax($async$result.$index(0, "jsarr")), new A.addBackendlessLinks_closure());
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = J;
              $async$goto = 2;
              return A._asyncAwait(A.Data_find("todo", new A.DataQuery(t1)), $async$addBackendlessTodos);
            case 2:
              // returning from await.
              $async$temp1.forEach$1$ax($async$result.$index(0, "jsarr"), new A.addBackendlessTodos_closure());
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
  ...
  A.MapView.prototype = {
    ...
    putIfAbsent$2(key, ifAbsent) {
      var t1 = A._instanceType(this);
      return this._collection$_map.putIfAbsent$2(t1._precomputed1._as(key), t1._eval$1("2()")._as(ifAbsent));
    },
    containsKey$1(key) {
  ...
  A._Storage.prototype = {
    $get$2(owner, key) {
      ...
      return space == null ? null : space.$index(0, key);
    },
    getSpace$1(owner) {
      var space,
        t1 = this._cache;
    ...
    remove$2(_, owner, key) {
      ...
      space = t1._jsWeakMap.get(owner);
      if (space != null) {
        space.remove$1(0, key);
        if (space.get$isEmpty(space))
  ...
  A.main_closure2.prototype = {
    ...
    $call$body$main_closure3(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $prompt, $async$temp1, $async$temp2, $async$temp3, $async$temp4;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $prompt = A._asStringQ($.$get$_context().callMethod$2("prompt", ["Input new issue"]));
              ...
              $async$temp4 = J;
              $async$goto = 3;
              return A._asyncAwait(A.Data_add("todo", A._setArrayType([A.LinkedHashMap_LinkedHashMap$_literal(["name", $prompt, "status", "todo"], type$.String, type$.dynamic)], type$.JSArray_Map_String_dynamic)), $async$call$1);
            case 3:
              // returning from await.
              $async$temp1.addTodo($async$temp2, "todo", $async$temp3._asString($async$temp4.$index$asx($async$result.$index(0, "jsarr"), 0)));
            case 1:
              // return
              return A._asyncReturn($async$returnValue, $async$completer);
          }
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              $async$goto = 5;
              return A._asyncAwait(A.Data_delete("notes", $.__currentNoteId), $async$call$1);
            case 5:
              // returning from await.
  ...
  A.main_closure6.prototype = {
    ...
    $call$body$main_closure(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        ia, j, _created, t2, t3, t4, t5, t1, ta;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            ...
            case 5:
              // then
              $async$goto = 7;
              return A._asyncAwait(A.Data_add("notes", A._setArrayType([A.LinkedHashMap_LinkedHashMap$_literal(["content", t1, "type", ia.value], type$.String, type$.dynamic)], type$.JSArray_Map_String_dynamic)), $async$call$1);
            case 7:
              // returning from await.
              j = $async$result;
              ...
              if (t5 == null)
                t5 = A._asString(t5);
              A.addNote(t4, t1 + " " + t2 + ", " + t3, t5, A._asString(J.$index$asx(j.$index(0, "jsarr"), 0)));
            case 6:
              // join
              // goto join
              $async$goto = 3;
            ...
            case 8:
              // then
              $async$goto = 10;
              return A._asyncAwait(A.Data_update("notes", t1, A.LinkedHashMap_LinkedHashMap$_literal(["content", t2, "type", ia.value], type$.String, type$.dynamic)), $async$call$1);
            case 10:
              // returning from await.
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 2:
              ...
              $async$goto = 5;
              return A._asyncAwait(A.Data_add("links", A._setArrayType([A.LinkedHashMap_LinkedHashMap$_literal(["name", t4, "href", t6, "category", t8, "priority", A.int_parse(t9 == null ? A._asString(t9) : t9, null)], type$.String, type$.dynamic)], type$.JSArray_Map_String_dynamic)), $async$call$1);
            case 5:
              // returning from await.
              t1 = A.$(t1, null);
            ...
            case 4:
              ...
              $async$goto = 6;
              return A._asyncAwait(A.Data_update("links", t1, A.LinkedHashMap_LinkedHashMap$_literal(["name", t4, "href", t5, "category", t6, "priority", A.int_parse(t3 == null ? A._asString(t3) : t3, null)], type$.String, type$.dynamic)), $async$call$1);
            case 6:
              // returning from await.
            case 3:
              // join
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 2:
              // then
              $async$goto = 4;
              return A._asyncAwait(A.Data_delete("links", t1), $async$call$1);
            case 4:
              // returning from await.
  ...
  A.addTodo_closure.prototype = {
    call$1(e) {
      ...
      if (e.get$button(e) === 0) {
        ...
        t4 = type$.dynamic;
        if (t1.status === "done") {
          A.Data_update(_s4_, t2, A.LinkedHashMap_LinkedHashMap$_literal(["status", "todo"], t3, t4));
          t1.status = _s4_;
        } else {
          A.Data_update(_s4_, t2, A.LinkedHashMap_LinkedHashMap$_literal(["status", "done"], t3, t4));
          t1.status = "done";
        }
      }
      if (e.get$button(e) === 1) {
        A.Data_update(_s4_, _this.oid, A.LinkedHashMap_LinkedHashMap$_literal(["status", "doing"], type$.String, type$.dynamic));
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "collection___defaultHashCode$closure", "_defaultHashCode", 31);
    ...
    _static_1(A, "core__identityHashCode$closure", "identityHashCode", 31);
    ...
    _static_2(A, "dquery___appendFunc$closure", "_appendFunc", 15);
    _static_2(A, "dquery___prependFunc$closure", "_prependFunc", 15);
