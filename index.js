...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _EventUtil_add(eventTarget, types, handler, selector) {
      ...
      events = t1.putIfAbsent$2(space, "events", B.CONSTANT0);
      eventHandles = t1.putIfAbsent$2(space, "handles", B.CONSTANT0);
    ...
    _EventUtil_remove(elem, types, handler, selector, mappedTypes) {
      var t1, t2, t3, t4, t5, t6, _i, _box_0, type, t7, t8, namespaces, ns, _i0, special, type0, handleObjCtx, delegates, handlers, filter, space, eventHandles, eventHandle,
        _s11_ = "removeWhere",
        events = $.$get$_dataPriv().$get$2(elem, "events");
      if (events == null)
        return;
      t1 = B.JSString_methods.split$1(types, $.$get$_EventUtil__SPACES());
      t2 = t1.length;
    ...
    _EventUtil__getEvents(elem) {
      var t1 = $.$get$_dataPriv().$get$2(elem, "events");
      if (t1 == null) {
        t1 = type$.dynamic;
    ...
    _cleanData(element) {
      var t1, t2, t3, t4, _i, c, t5, t6, t7, t8, space;
      for (t1 = J.get$children$x(element), t1 = t1.toList$0(t1), t2 = t1.length, t3 = type$.Object, t4 = type$.Map_dynamic_dynamic, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
        ...
        if (t5.containsKey$1(space, "events"))
          for (t5 = J.get$iterator$ax(J.get$keys$x(t4._as(t5.$index(space, "events")))); t5.moveNext$0();)
            A._EventUtil_remove(c, A._asString(t5.get$current()), null, null, false);
        t5 = $.$get$_dataPriv();
        t6 = t6 ? t3._as(c) : c;
    ...
    QueryEvent: function QueryEvent(t0, t1) {
      ...
      _.originalEvent = t0;
      _._type = t1;
      _._defaultPrevented = _._handleObj = _._reNamespace = _._namespace = _._dquery$_target = _._currentTarget = _._delegateTarget = null;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp2 = B.C_Utf8Codec;
              $async$goto = 3;
              return A._asyncAwait(A.get0(A._Uri__makeHttpUri("https", t1, "api/data/" + table, query.query), headers), $async$Data_find);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1.jsonDecode($async$temp2.decode$1(0, $async$result.bodyBytes));
              // goto return
    ...
    setupSaltcornDB() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        t1, t2, t3, fields, i, field, t4, id, data;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A.get("tools", null), $async$setupSaltcornDB);
            case 2:
              // returning from await.
              data = $async$result;
              ...
              fields = J.$index$asx(data, "jsarr");
              for (t2 = J.getInterceptor$asx(fields), t3 = type$.Map_String_dynamic, i = 0; i < A._asNum(t2.get$length(fields)); ++i) {
                field = t3._as(t2.$index(fields, i));
                t4 = J.getInterceptor$asx(field);
                id = "tools-el-" + A.S(t4.$index(field, "objectId"));
                A.addTool(A._asString(t4.$index(field, "name")), A._asString(t4.$index(field, "description")), A._asString(t4.$index(field, "href")), A._asString(t4.$index(field, "tags")), id);
                A.$("#tool-searchbar", null)._on$4("input", t1._as(new A.setupSaltcornDB_closure3(field, id)), null, false);
    ...
    addLinkTo($name, href, whereid, priority, oid) {
      ...
      if (!t1) {
        ...
        A._domManip(q, A.Element_Element$html('            <a id="c-link-' + $.__link_id + '" class="c-link button-no-style">\n                ' + $name + "\n            </a>\n        ", _null, new A.NodeValidatorAllowAll()), A.dquery___appendFunc$closure());
        A.$("#c-link-" + linkID, _null)._on$4("mouseup", type$.void_Function_QueryEvent._as(new A.addLinkTo_closure(href)), _null, false);
      ...
      A.$("#link-submit-" + t1, _null)._on$4("click", t2._as(new A.addLinkTo_closure0(oid, linkID)), _null, false);
      A.$("#link-delete-" + t1, _null)._on$4("click", t2._as(new A.addLinkTo_closure1(oid, linkID)), _null, false);
    },
    addBackendlessTodos() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
    ...
    addLinkTo_closure1: function addLinkTo_closure1(t0, t1) {
      this.oid = t0;
      this.linkID = t1;
    },
  ...
  A._EventStreamSubscription.prototype = {
    ...
    _tryResume$0() {
      ...
      if (t1 != null) {
        t2 = this._target;
        t2.toString;
        B.HttpRequest_methods.addEventListener$3(t2, this._eventType, t1, false);
      }
    },
    _unlisten$0() {
      var t2,
      ...
      if (t1 != null) {
        t2 = this._target;
        t2.toString;
        B.HttpRequest_methods.removeEventListener$3(t2, this._eventType, t1, false);
      }
    },
    set$_onData(_onData) {
  ...
  A._DOMWindowCrossFrame.prototype = {
    ...
    removeEventListener$3(_, type, listener, useCapture) {
      type$.nullable_dynamic_Function_Event._as(listener);
      return A.throwExpression(A.UnsupportedError$(string$.You_ca));
    },
    removeEventListener$2(_, type, listener) {
      return this.removeEventListener$3(0, type, listener, null);
    },
    $isEventTarget: 1,
    $isWindowBase: 1
  };
  ...
  A.CanonicalizedMap_putIfAbsent_closure.prototype = {
    call$0() {
      var t1 = this.$this.$ti;
      return new A.MapEntry(this.key, this.ifAbsent.call$0(), t1._eval$1("@<CanonicalizedMap.K>")._bind$1(t1._eval$1("CanonicalizedMap.V"))._eval$1("MapEntry<1,2>"));
    },
    $signature() {
  ...
  A._ElementQuery.prototype = {
    ...
    children$0(_) {
      ...
      for (t1 = J.get$iterator$ax(this._elements); t1.moveNext$0();)
        for (t2 = J.get$children$x(t1.get$current()), t2 = t2.get$iterator(t2), t3 = t2.$ti._precomputed1; t2.moveNext$0();) {
          t4 = t2._current;
          if (t4 == null)
            t4 = t3._as(t4);
    ...
    addClass$1($name) {
      var t1;
      for (t1 = J.get$iterator$ax(this._elements); t1.moveNext$0();)
        J.get$classes$x(t1.get$current()).add$1(0, $name);
    },
    removeClass$1($name) {
      var t1;
      for (t1 = J.get$iterator$ax(this._elements); t1.moveNext$0();)
        J.get$classes$x(t1.get$current()).remove$1(0, $name);
    },
    clone$0(_) {
  ...
  A._initNotSupportFocusinBubbles_closure.prototype = {
    call$1($event) {
      ...
      e._dquery$_target = J.get$target$x($event);
  ...
  A.QueryEvent.prototype = {
    ...
    get$target(_) {
      var _this = this,
        t1 = _this._dquery$_target;
      if (t1 == null && _this.originalEvent != null) {
        t1 = _this.originalEvent;
        t1.toString;
        t1 = _this._dquery$_target = J.get$target$x(t1);
        if (type$.Text._is(t1)) {
          t1 = t1.parentNode;
          _this._dquery$_target = t1;
        }
      }
      return t1;
    },
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              t4 = type$.void;
              new A._EventStream(t2._as(xhr), "load", false, t3).get$first(0).then$1$1(new A.BrowserClient_send_closure(xhr, completer, request), t4);
              new A._EventStream(t2._as(xhr), "error", false, t3).get$first(0).then$1$1(new A.BrowserClient_send_closure0(completer, request), t4);
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 7:
              // returning from await.
              _id = $async$result;
              _created = new A.DateTime(Date.now(), false);
  ...
  A.setupSaltcornDB_closure3.prototype = {
    call$1(e) {
      var t1, text, t2;
      type$.QueryEvent._as(e);
      t1 = A.$("#tool-searchbar", null);
      text = type$.InputElement._as(t1.get$first(t1)).value;
      if (text == null)
        text = A._asString(text);
      t1 = this.field;
      t2 = J.getInterceptor$asx(t1);
      t1 = B.JSString_methods.contains$1(A._asString(t2.$index(t1, "name")).toLowerCase(), text.toLowerCase()) || B.JSString_methods.contains$1(A._asString(t2.$index(t1, "tags")).toLowerCase(), text.toLowerCase()) || B.JSString_methods.contains$1(A._asString(t2.$index(t1, "description")).toLowerCase(), text.toLowerCase());
      t2 = "#" + this.id;
      if (t1)
        A._showHide(A.$(t2, null)._elements, true);
      else
        A._showHide(A.$(t2, null)._elements, false);
    },
    $signature: 1
  };
  ...
  A.addBackendlessNotes_closure.prototype = {
    call$1(obj) {
      var t1 = J.getInterceptor$asx(obj),
        _created = A.DateTime$fromMillisecondsSinceEpoch(A._asInt(t1.$index(obj, "created")), false),
  ...
  A.addLinkTo_closure1.prototype = {
    call$1(e) {
  ...
  (function installTearOffs() {
    ...
    _instance(A._Completer.prototype, "get$completeError", 0, 1, function() {
      return [null];
    }, ["call$2", "call$1"], ["completeError$2", "completeError$1"], 74, 0, 0);
    ...
    _static_2(A, "collection_ListBase__compareAny$closure", "ListBase__compareAny", 15);
    _static_1(A, "convert___defaultToEncodable$closure", "_defaultToEncodable", 6);
    var _;
    _instance_1_i(_ = A._ByteCallbackSink.prototype, "get$add", "add$1", 51);
    ...
    _instance_2_i(A.HttpRequest.prototype, "get$setRequestHeader", "setRequestHeader$2", 7);
    _static_1(A, "js___convertToJS$closure", "_convertToJS", 78);
    _static_1(A, "js___convertToDart$closure", "_convertToDart", 79);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(QueryEvent)", "Future<~>(QueryEvent)", "Null()", "Null(@)", "~(Element)", "@(@)", "~(String,String)", "~(String,@)", "~(@)", "String(String)", "Future<Response>(Client)", "bool(String)", "~(Object,StackTrace)", "~(~())", "int(@,@)", "Null(Event)", "bool(_Highlight)", "~(Event)", "bool(EventTarget,@)", "bool()", "bool(Element,String,String,_Html5NodeValidator)", "bool(NodeValidator)", "Null(ProgressEvent)", "String(Match)", "bool(Node)", "int()", "~(Element,ElementQuery)", "bool(EventTarget?)", "@()", "~(Object?,Object?)", "bool(Object?,Object?)", "int(Object?)", "~(Uint8List,String,int)", "Uint8List(@,@)", "~(Node,Node?)", "@(@,@)", "bool(Set<String>)", "Element(Node)", "bool(@)", "JsFunction(@)", "JsArray<@>(@)", "JsObject(@)", "~(EventTarget)", "Element(Element)", "Null(@)()", "_HandleObjectContext()", "bool(_HandleObject)", "~(@,@)", "@(@,String)", "Null(~())", "~(Object?)", "EventTarget(@)", "~(Symbol0,@)", "0^(0^,0^)<num>", "int(String)", "~(String,int)", "~(List<int>)", "MediaType()", "~(String,int?)", "String(String?)", "String?()", "int(_Line)", "int(int,int)", "Object(_Line)", "Object(_Highlight)", "int(_Highlight,_Highlight)", "List<_Line>(MapEntry<Object,List<_Highlight>>)", "Null(@,StackTrace)", "SourceSpanWithContext()", "~(String,Object)", "~(String,String?)", "Future<Null>()", "~(int,@)", "~(Object[StackTrace?])", "@(String)", "Null(Object,StackTrace)", "_Future<@>(@)", "Object?(Object?)", "Object?(@)", "Null(~)", "Map<0^,1^>()<Object?,Object?>", "bool(String,String)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","AElement":"SvgElement","GraphicsElement":"SvgElement","OpenDBRequest":"EventTarget","Request0":"EventTarget","_ResourceProgressEvent":"ProgressEvent","AudioElement":"HtmlElement","MediaElement":"HtmlElement","ShadowRoot":"Node","DocumentFragment":"Node","XmlDocument":"Document","PointerEvent":"MouseEvent","CompositionEvent":"UIEvent","DedicatedWorkerGlobalScope":"WorkerGlobalScope","Comment":"CharacterData","MathMLElement":"Element","HtmlFormControlsCollection":"HtmlCollection","File":"Blob","CDataSection":"Text","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"Null":[],"TrustedGetRuntimeType":[]},"JSArray":{"List":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"ArrayIterator":{"Iterator":["1"]},"JSNumber":{"double":[],"num":[],"Comparable":["num"]},"JSInt":{"double":[],"int":[],"num":[],"Comparable":["num"],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"double":[],"num":[],"Comparable":["num"],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"Comparable":["String"],"Pattern":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"CodeUnits":{"ListBase":["int"],"UnmodifiableListMixin":["int"],"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"ListBase.E":"int","UnmodifiableListMixin.E":"int"},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"EfficientLengthIterable":["1"],"Iterable":["1"]},"SubListIterable":{"ListIterable":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"],"ListIterable.E":"1","Iterable.E":"1"},"ListIterator":{"Iterator":["1"]},"MappedIterable":{"Iterable":["2"],"Iterable.E":"2"},"EfficientLengthMappedIterable":{"MappedIterable":["1","2"],"EfficientLengthIterable":["2"],"Iterable":["2"],"Iterable.E":"2"},"MappedIterator":{"Iterator":["2"]},"MappedListIterable":{"ListIterable":["2"],"EfficientLengthIterable":["2"],"Iterable":["2"],"ListIterable.E":"2","Iterable.E":"2"},"WhereIterable":{"Iterable":["1"],"Iterable.E":"1"},"WhereIterator":{"Iterator":["1"]},"ExpandIterable":{"Iterable":["2"],"Iterable.E":"2"},"ExpandIterator":{"Iterator":["2"]},"TakeIterable":{"Iterable":["1"],"Iterable.E":"1"},"EfficientLengthTakeIterable":{"TakeIterable":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"],"Iterable.E":"1"},"TakeIterator":{"Iterator":["1"]},"SkipIterable":{"Iterable":["1"],"Iterable.E":"1"},"EfficientLengthSkipIterable":{"SkipIterable":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"],"Iterable.E":"1"},"SkipIterator":{"Iterator":["1"]},"EmptyIterable":{"EfficientLengthIterable":["1"],"Iterable":["1"],"Iterable.E":"1"},"EmptyIterator":{"Iterator":["1"]},"WhereTypeIterable":{"Iterable":["1"],"Iterable.E":"1"},"WhereTypeIterator":{"Iterator":["1"]},"UnmodifiableListBase":{"ListBase":["1"],"UnmodifiableListMixin":["1"],"List":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"ReversedListIterable":{"ListIterable":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"],"ListIterable.E":"1","Iterable.E":"1"},"Symbol":{"Symbol0":[]},"ConstantMapView":{"UnmodifiableMapView":["1","2"],"_UnmodifiableMapView_MapView__UnmodifiableMapMixin":["1","2"],"MapView":["1","2"],"_UnmodifiableMapMixin":["1","2"],"Map":["1","2"]},"ConstantMap":{"Map":["1","2"]},"ConstantStringMap":{"ConstantMap":["1","2"],"Map":["1","2"]},"_KeysOrValues":{"Iterable":["1"],"Iterable.E":"1"},"_KeysOrValuesOrElementsIterator":{"Iterator":["1"]},"Instantiation":{"Closure":[],"Function":[]},"Instantiation1":{"Closure":[],"Function":[]},"Instantiation2":{"Closure":[],"Function":[]},"JSInvocationMirror":{"Invocation":[]},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"NullThrownFromJavaScriptException":{"Exception":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Closure":[],"Function":[]},"Closure2Args":{"Closure":[],"Function":[]},"TearOffClosure":{"Closure":[],"Function":[]},"StaticClosure":{"Closure":[],"Function":[]},"BoundClosure":{"Closure":[],"Function":[]},"_CyclicInitializationError":{"Error":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"JsLinkedHashMap":{"MapBase":["1","2"],"LinkedHashMap":["1","2"],"Map":["1","2"],"MapBase.K":"1","MapBase.V":"2"},"LinkedHashMapKeyIterable":{"EfficientLengthIterable":["1"],"Iterable":["1"],"Iterable.E":"1"},"LinkedHashMapKeyIterator":{"Iterator":["1"]},"JsIdentityLinkedHashMap":{"JsLinkedHashMap":["1","2"],"MapBase":["1","2"],"LinkedHashMap":["1","2"],"Map":["1","2"],"MapBase.K":"1","MapBase.V":"2"},"JSSyntaxRegExp":{"RegExp":[],"Pattern":[]},"_MatchImplementation":{"RegExpMatch":[],"Match":[]},"_AllMatchesIterable":{"Iterable":["RegExpMatch"],"Iterable.E":"RegExpMatch"},"_AllMatchesIterator":{"Iterator":["RegExpMatch"]},"StringMatch":{"Match":[]},"_StringAllMatchesIterable":{"Iterable":["Match"],"Iterable.E":"Match"},"_StringAllMatchesIterator":{"Iterator":["Match"]},"NativeByteBuffer":{"ByteBuffer":[],"TrustedGetRuntimeType":[]},"NativeTypedData":{"TypedData":[]},"NativeByteData":{"TypedData":[],"TrustedGetRuntimeType":[]},"NativeTypedArray":{"JavaScriptIndexingBehavior":["1"],"TypedData":[]},"NativeTypedArrayOfDouble":{"ListBase":["double"],"NativeTypedArray":["double"],"List":["double"],"JavaScriptIndexingBehavior":["double"],"EfficientLengthIterable":["double"],"TypedData":[],"Iterable":["double"],"FixedLengthListMixin":["double"]},"NativeTypedArrayOfInt":{"ListBase":["int"],"NativeTypedArray":["int"],"List":["int"],"JavaScriptIndexingBehavior":["int"],"EfficientLengthIterable":["int"],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"]},"NativeFloat32List":{"ListBase":["double"],"NativeTypedArray":["double"],"List":["double"],"JavaScriptIndexingBehavior":["double"],"EfficientLengthIterable":["double"],"TypedData":[],"Iterable":["double"],"FixedLengthListMixin":["double"],"TrustedGetRuntimeType":[],"ListBase.E":"double","FixedLengthListMixin.E":"double"},"NativeFloat64List":{"ListBase":["double"],"NativeTypedArray":["double"],"List":["double"],"JavaScriptIndexingBehavior":["double"],"EfficientLengthIterable":["double"],"TypedData":[],"Iterable":["double"],"FixedLengthListMixin":["double"],"TrustedGetRuntimeType":[],"ListBase.E":"double","FixedLengthListMixin.E":"double"},"NativeInt16List":{"NativeTypedArrayOfInt":[],"ListBase":["int"],"NativeTypedArray":["int"],"List":["int"],"JavaScriptIndexingBehavior":["int"],"EfficientLengthIterable":["int"],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListBase.E":"int","FixedLengthListMixin.E":"int"},"NativeInt32List":{"NativeTypedArrayOfInt":[],"ListBase":["int"],"NativeTypedArray":["int"],"List":["int"],"JavaScriptIndexingBehavior":["int"],"EfficientLengthIterable":["int"],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListBase.E":"int","FixedLengthListMixin.E":"int"},"NativeInt8List":{"NativeTypedArrayOfInt":[],"ListBase":["int"],"NativeTypedArray":["int"],"List":["int"],"JavaScriptIndexingBehavior":["int"],"EfficientLengthIterable":["int"],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListBase.E":"int","FixedLengthListMixin.E":"int"},"NativeUint16List":{"NativeTypedArrayOfInt":[],"ListBase":["int"],"NativeTypedArray":["int"],"List":["int"],"JavaScriptIndexingBehavior":["int"],"EfficientLengthIterable":["int"],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListBase.E":"int","FixedLengthListMixin.E":"int"},"NativeUint32List":{"NativeTypedArrayOfInt":[],"ListBase":["int"],"Uint32List":[],"NativeTypedArray":["int"],"List":["int"],"JavaScriptIndexingBehavior":["int"],"EfficientLengthIterable":["int"],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListBase.E":"int","FixedLengthListMixin.E":"int"},"NativeUint8ClampedList":{"NativeTypedArrayOfInt":[],"ListBase":["int"],"NativeTypedArray":["int"],"List":["int"],"JavaScriptIndexingBehavior":["int"],"EfficientLengthIterable":["int"],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListBase.E":"int","FixedLengthListMixin.E":"int"},"NativeUint8List":{"NativeTypedArrayOfInt":[],"ListBase":["int"],"Uint8List":[],"NativeTypedArray":["int"],"List":["int"],"JavaScriptIndexingBehavior":["int"],"EfficientLengthIterable":["int"],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListBase.E":"int","FixedLengthListMixin.E":"int"},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"_Future":{"Future":["1"]},"AsyncError":{"Error":[]},"_AsyncCompleter":{"_Completer":["1"]},"StreamView":{"Stream":["1"]},"_StreamController":{"_StreamControllerLifecycle":["1"],"_EventDispatch":["1"]},"_AsyncStreamController":{"_AsyncStreamControllerDispatch":["1"],"_StreamController":["1"],"_StreamControllerLifecycle":["1"],"_EventDispatch":["1"]},"_ControllerStream":{"_StreamImpl":["1"],"Stream":["1"],"Stream.T":"1"},"_ControllerSubscription":{"_BufferingStreamSubscription":["1"],"StreamSubscription":["1"],"_EventDispatch":["1"]},"_BufferingStreamSubscription":{"StreamSubscription":["1"],"_EventDispatch":["1"]},"_StreamImpl":{"Stream":["1"]},"_DelayedData":{"_DelayedEvent":["1"]},"_DelayedDone":{"_DelayedEvent":["@"]},"_DoneStreamSubscription":{"StreamSubscription":["1"]},"_EmptyStream":{"Stream":["1"],"Stream.T":"1"},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"_LinkedCustomHashMap":{"JsLinkedHashMap":["1","2"],"MapBase":["1","2"],"LinkedHashMap":["1","2"],"Map":["1","2"],"MapBase.K":"1","MapBase.V":"2"},"_LinkedHashSet":{"SetBase":["1"],"Set":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"],"SetBase.E":"1"},"_LinkedHashSetIterator":{"Iterator":["1"]},"ListBase":{"List":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"MapBase":{"Map":["1","2"]},"MapView":{"Map":["1","2"]},"UnmodifiableMapView":{"_UnmodifiableMapView_MapView__UnmodifiableMapMixin":["1","2"],"MapView":["1","2"],"_UnmodifiableMapMixin":["1","2"],"Map":["1","2"]},"SetBase":{"Set":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"_SetBase":{"SetBase":["1"],"Set":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"Encoding":{"Codec":["String","List<int>"]},"_JsonMap":{"MapBase":["String","@"],"Map":["String","@"],"MapBase.K":"String","MapBase.V":"@"},"_JsonMapKeyIterable":{"ListIterable":["String"],"EfficientLengthIterable":["String"],"Iterable":["String"],"ListIterable.E":"String","Iterable.E":"String"},"AsciiCodec":{"Encoding":[],"Codec":["String","List<int>"]},"Base64Codec":{"Codec":["List<int>","String"]},"JsonUnsupportedObjectError":{"Error":[]},"JsonCyclicError":{"Error":[]},"JsonCodec":{"Codec":["Object?","String"]},"Latin1Codec":{"Encoding":[],"Codec":["String","List<int>"]},"Utf8Codec":{"Encoding":[],"Codec":["String","List<int>"]},"DateTime":{"Comparable":["DateTime"]},"double":{"num":[],"Comparable":["num"]},"int":{"num":[],"Comparable":["num"]},"List":{"EfficientLengthIterable":["1"],"Iterable":["1"]},"num":{"Comparable":["num"]},"RegExpMatch":{"Match":[]},"Set":{"EfficientLengthIterable":["1"],"Iterable":["1"]},"String":{"Comparable":["String"],"Pattern":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"NoSuchMethodError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"OutOfMemoryError":{"Error":[]},"StackOverflowError":{"Error":[]},"_Exception":{"Exception":[]},"FormatException":{"Exception":[]},"_StringStackTrace":{"StackTrace":[]},"StringBuffer":{"StringSink":[]},"_Uri":{"Uri":[]},"_SimpleUri":{"Uri":[]},"_DataUri":{"Uri":[]},"Element":{"Node":[],"EventTarget":[]},"HtmlDocument":{"Document":[],"Node":[],"EventTarget":[]},"HttpRequest":{"EventTarget":[]},"Node":{"EventTarget":[]},"ProgressEvent":{"Event":[]},"_Html5NodeValidator":{"NodeValidator":[]},"HtmlElement":{"Element":[],"Node":[],"EventTarget":[]},"AnchorElement":{"Element":[],"Node":[],"EventTarget":[]},"AreaElement":{"Element":[],"Node":[],"EventTarget":[]},"BaseElement":{"Element":[],"Node":[],"EventTarget":[]},"BodyElement":{"Element":[],"Node":[],"EventTarget":[]},"CharacterData":{"Node":[],"EventTarget":[]},"Document":{"Node":[],"EventTarget":[]},"_ChildrenElementList":{"ListBase":["Element"],"List":["Element"],"EfficientLengthIterable":["Element"],"Iterable":["Element"],"ListBase.E":"Element"},"_FrozenElementList":{"ListBase":["1"],"List":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"],"ListBase.E":"1"},"FocusEvent":{"Event":[]},"FormElement":{"Element":[],"Node":[],"EventTarget":[]},"HtmlCollection":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"EfficientLengthIterable":["Node"],"Iterable":["Node"],"ImmutableListMixin.E":"Node","ListBase.E":"Node"},"HttpRequestEventTarget":{"EventTarget":[]},"InputElement":{"Element":[],"Node":[],"EventTarget":[]},"MouseEvent":{"Event":[]},"_ChildNodeListLazy":{"ListBase":["Node"],"List":["Node"],"EfficientLengthIterable":["Node"],"Iterable":["Node"],"ListBase.E":"Node"},"NodeList":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"EfficientLengthIterable":["Node"],"Iterable":["Node"],"ImmutableListMixin.E":"Node","ListBase.E":"Node"},"OListElement":{"Element":[],"Node":[],"EventTarget":[]},"SelectElement":{"Element":[],"Node":[],"EventTarget":[]},"Storage":{"MapBase":["String","String"],"Map":["String","String"],"MapBase.K":"String","MapBase.V":"String"},"TableElement":{"Element":[],"Node":[],"EventTarget":[]},"TableRowElement":{"Element":[],"Node":[],"EventTarget":[]},"TableSectionElement":{"Element":[],"Node":[],"EventTarget":[]},"TemplateElement":{"Element":[],"Node":[],"EventTarget":[]},"Text":{"CharacterData":[],"Node":[],"EventTarget":[]},"TextAreaElement":{"Element":[],"Node":[],"EventTarget":[]},"UIEvent":{"Event":[]},"Window":{"WindowBase":[],"EventTarget":[]},"WorkerGlobalScope":{"EventTarget":[]},"_Attr":{"Node":[],"EventTarget":[]},"_NamedNodeMap":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"EfficientLengthIterable":["Node"],"Iterable":["Node"],"ImmutableListMixin.E":"Node","ListBase.E":"Node"},"_AttributeMap":{"MapBase":["String","String"],"Map":["String","String"]},"_ElementAttributeMap":{"MapBase":["String","String"],"Map":["String","String"],"MapBase.K":"String","MapBase.V":"String"},"_ElementCssClassSet":{"SetBase":["String"],"Set":["String"],"EfficientLengthIterable":["String"],"Iterable":["String"],"SetBase.E":"String"},"_EventStream":{"Stream":["1"],"Stream.T":"1"},"_EventStreamSubscription":{"StreamSubscription":["1"]},"NodeValidatorBuilder":{"NodeValidator":[]},"_SimpleNodeValidator":{"NodeValidator":[]},"_TemplatingNodeValidator":{"NodeValidator":[]},"_SvgNodeValidator":{"NodeValidator":[]},"FixedSizeListIterator":{"Iterator":["1"]},"_DOMWindowCrossFrame":{"WindowBase":[],"EventTarget":[]},"_SameOriginUriPolicy":{"UriPolicy":[]},"_ValidatingTreeSanitizer":{"NodeTreeSanitizer":[]},"CssClassSetImpl":{"SetBase":["String"],"Set":["String"],"EfficientLengthIterable":["String"],"Iterable":["String"]},"FilteredElementList":{"ListBase":["Element"],"List":["Element"],"EfficientLengthIterable":["Element"],"Iterable":["Element"],"ListBase.E":"Element"},"VersionChangeEvent":{"Event":[]},"JsArray":{"ListBase":["1"],"List":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"],"ListBase.E":"1"},"NullRejectionException":{"Exception":[]},"ScriptElement0":{"SvgElement":[],"Element":[],"Node":[],"EventTarget":[]},"AttributeClassSet":{"SetBase":["String"],"Set":["String"],"EfficientLengthIterable":["String"],"Iterable":["String"],"SetBase.E":"String"},"SvgElement":{"Element":[],"Node":[],"EventTarget":[]},"CanonicalizedMap":{"Map":["2","3"]},"ElementQuery":{"List":["Element"],"EfficientLengthIterable":["Element"],"Iterable":["Element"]},"QueryEvent":{"Event":[]},"_Query":{"List":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"_DocumentQuery":{"_Query":["HtmlDocument"],"ListBase":["HtmlDocument"],"List":["HtmlDocument"],"EfficientLengthIterable":["HtmlDocument"],"Iterable":["HtmlDocument"],"ListBase.E":"HtmlDocument"},"_ElementQuery":{"ElementQuery":[],"_Query":["Element"],"ListBase":["Element"],"List":["Element"],"EfficientLengthIterable":["Element"],"Iterable":["Element"],"ListBase.E":"Element"},"BaseClient":{"Client":[]},"BrowserClient":{"Client":[]},"ByteStream":{"StreamView":["List<int>"],"Stream":["List<int>"],"StreamView.T":"List<int>","Stream.T":"List<int>"},"ClientException":{"Exception":[]},"Request":{"BaseRequest":[]},"CaseInsensitiveMap":{"CanonicalizedMap":["String","String","1"],"Map":["String","1"],"CanonicalizedMap.K":"String","CanonicalizedMap.V":"1","CanonicalizedMap.C":"String"},"PathException":{"Exception":[]},"PosixStyle":{"InternalStyle":[]},"UrlStyle":{"InternalStyle":[]},"WindowsStyle":{"InternalStyle":[]},"FileLocation":{"SourceLocation":[],"Comparable":["SourceLocation"]},"_FileSpan":{"SourceSpanWithContext":[],"SourceSpan":[],"Comparable":["SourceSpan"]},"SourceLocation":{"Comparable":["SourceLocation"]},"SourceLocationMixin":{"SourceLocation":[],"Comparable":["SourceLocation"]},"SourceSpan":{"Comparable":["SourceSpan"]},"SourceSpanBase":{"SourceSpan":[],"Comparable":["SourceSpan"]},"SourceSpanException":{"Exception":[]},"SourceSpanFormatException":{"FormatException":[],"Exception":[]},"SourceSpanMixin":{"SourceSpan":[],"Comparable":["SourceSpan"]},"SourceSpanWithContext":{"SourceSpan":[],"Comparable":["SourceSpan"]},"StringScannerException":{"FormatException":[],"Exception":[]},"NodeValidatorAllowAll":{"NodeValidator":[]},"ByteData":{"TypedData":[]},"Int8List":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"TypedData":[]},"Uint8List":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"TypedData":[]},"Uint8ClampedList":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"TypedData":[]},"Int16List":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"TypedData":[]},"Uint16List":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"TypedData":[]},"Int32List":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"TypedData":[]},"Uint32List":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"TypedData":[]},"Float32List":{"List":["double"],"EfficientLengthIterable":["double"],"Iterable":["double"],"TypedData":[]},"Float64List":{"List":["double"],"EfficientLengthIterable":["double"],"Iterable":["double"],"TypedData":[]}}'));
  A._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"UnmodifiableListBase":1,"NativeTypedArray":1,"_DelayedEvent":1,"_SetBase":1,"Converter":2,"_JsArray_JsObject_ListMixin":1}'));
  var string$ = {
  ...
  (function constants() {
    ...
    B.CONSTANT0 = new A.Instantiation2(A.dquery___createMap$closure(), A.findType("Instantiation2<@,@>"));
